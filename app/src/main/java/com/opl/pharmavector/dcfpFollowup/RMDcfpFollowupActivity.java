...
public class RMDcfpFollowupActivity extends Activity implements DcfpFollowupAdapter.DcfpClickListener {
    ...
    private void calenderInit() {
        ...
        tvfromdate.setOnClickListener(v -> new DatePickerDialog(RMDcfpFollowupActivity.this, date_form, myCalendar.get(Calendar.YEAR), myCalendar.get(Calendar.MONTH),
        ...
        tvtodate.setOnClickListener(v -> new DatePickerDialog(RMDcfpFollowupActivity.this, date_to, myCalendar
