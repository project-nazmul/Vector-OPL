package com.opl.pharmavector.exam;
 ...
 public class ExamBoardAdapter extends BaseAdapter implements Filterable {
     Context mContext;
     ...
     public ExamBoardAdapter(Activity activity, ArrayList<HashMap<String, String>> list, String productname, boolean state) {
         super();
     ...
     ExamBoardAdapter(Context con,ArrayList<String> sl, ArrayList<String> p_name,HashMap<Integer, String> p_quanty,ArrayList<String> value7,ArrayList<String> value8) {
         this.p_names = p_name;
     ...
     public View getView(final int position, View convertView, ViewGroup parent) {
         ...
         int srl = ExamAnswerBoard.nameSerialPair.get(holder.p_name.getText().toString());
         ...
         holder.p_name.setTextColor(Color.BLUE);
         holder.p_name.setTypeface(Typeface.DEFAULT_BOLD);
         return convertView;
     }
