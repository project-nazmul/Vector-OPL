...
public class RMDcrReport extends Activity implements OnClickListener {
    ...
    private String URL_PRODUCT_VIEW =BASE_URL+"regional_manager_api/rmdcr/DcrReportVal.php";
    private String URL_PRODUCT_VIEW1 =BASE_URL_RM+"DcrReportValSys.php";



    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.rmdcrreport);
        ...
        fromdate.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new DatePickerDialog(RMDcrReport.this, date_form, myCalendar.get(Calendar.YEAR), myCalendar.get(Calendar.MONTH),
        ...
        todate.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new DatePickerDialog(RMDcrReport.this, date_to, myCalendar
                ...
                Thread backthred = new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            Intent i = new Intent(RMDcrReport.this,  RmDashboard.class);
            ...
            public void onClick(final View v) {
                try {
                    ...
                    if (fromdate1.isEmpty()||(fromdate1.equals("From Date"))||(fromdate1.equals("From Date is required"))) {
                        ...
                        new RMDcrReport.GetCategories().execute();
                    }
	...
	*/
    ...
    class Spinner {
        ...
        private void populateSpinner() {
            ...
            RMDcrreportvalueProductShowAdapter adapter = new RMDcrreportvalueProductShowAdapter(RMDcrReport.this,sl,lables, quanty, value,value4,value5,value6,value7);
    ...
    private class GetCategories extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(RMDcrReport.this);
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            if (json != null) {
                ...
                Toast.makeText(RMDcrReport.this, "Nothing To Disply",Toast.LENGTH_SHORT).show();
                Toast.makeText(RMDcrReport.this, "Please make a order first !",Toast.LENGTH_LONG).show();
            }
            return null;
        }
        @Override
        protected void onPostExecute(Void result) {
            ...
            if (pDialog.isShowing())
                pDialog.dismiss();
            RMDcrReport.Spinner sp = new RMDcrReport.Spinner();
            sp.populateSpinner();
            popSpinner();
...
*/
    ...
    private class Getdcr extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            params.add(new BasicNameValuePair("ord_no", ord_no));
            ServiceHandler jsonParser = new ServiceHandler();
            String json = jsonParser.makeServiceCall(URL_PRODUCT_VIEW1, ServiceHandler.POST, params);
            Log.e("Response: ", "> " + json);
            if (json != null) {
                try {
                    JSONObject jsonObj = new JSONObject(json);
    ...
    private void view() {
        Intent i = new Intent(RMDcrReport.this, RMDcrReport.class);
        startActivity(i);
        finish();
