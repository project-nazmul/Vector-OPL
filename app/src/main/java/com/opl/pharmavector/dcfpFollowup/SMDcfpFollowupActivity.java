...
public class SMDcfpFollowupActivity extends Activity implements DcfpFollowupAdapter.DcfpClickListener {
    ...
    private void calenderInit() {
        ...
        tvfromdate.setOnClickListener(v -> new DatePickerDialog(SMDcfpFollowupActivity.this, date_form, myCalendar.get(Calendar.YEAR), myCalendar.get(Calendar.MONTH),
        ...
        tvtodate.setOnClickListener(v -> new DatePickerDialog(SMDcfpFollowupActivity.this, date_to, myCalendar
                .get(Calendar.YEAR), myCalendar.get(Calendar.MONTH),
                myCalendar1.get(Calendar.DAY_OF_MONTH)).show());
    }

    public void dcrDcfpFollowupInfo() {
        ProgressDialog dcfpFollowDialog = new ProgressDialog(SMDcfpFollowupActivity.this);
        ...
        call.enqueue(new Callback<List<DcrFollowupModel>>() {
            ...
            public void onResponse(@NonNull Call<List<DcrFollowupModel>> call, @NonNull retrofit2.Response<List<DcrFollowupModel>> response) {
                ...
                if (dcfpFollowupList.size() > 0) {
                    ...
                    dcfpFollowupAdapter = new DcfpFollowupAdapter(SMDcfpFollowupActivity.this, dcfpFollowupList, SMDcfpFollowupActivity.this, userRole);
                    LinearLayoutManager manager = new LinearLayoutManager(SMDcfpFollowupActivity.this);
                    dcfpFollowupRecycler.setLayoutManager(manager);
                    dcfpFollowupRecycler.setAdapter(dcfpFollowupAdapter);
                    dcfpFollowupRecycler.addItemDecoration(new DividerItemDecoration(SMDcfpFollowupActivity.this, DividerItemDecoration.VERTICAL));
                } else {
                    dcfpFollowDialog.dismiss();
                    Toast.makeText(SMDcfpFollowupActivity.this, "No data Available!", Toast.LENGTH_LONG).show();
                }
            }
    ...
    public void onDcfpClick(int position, DcrFollowupModel model) {
        Intent intent = new Intent(SMDcfpFollowupActivity.this, ASMDcfpFollowupActivity.class);
        ...
        intent.putExtra("designation", ff_code);
