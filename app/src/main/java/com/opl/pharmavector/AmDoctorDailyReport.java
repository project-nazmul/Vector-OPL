...
public class AmDoctorDailyReport extends Activity implements OnClickListener {
    ...
    private final String URL_PRODUCT_VIEW =BASE_URL_AM+"DoctorFollowup.php";
    private final String URL_MPO = BASE_URL_AM+"dcr_doctor.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.amdoctordcrreport);
        ...
        Toast.makeText(AmDoctorDailyReport.this, userName, Toast.LENGTH_LONG).show();
        ...
        Log.w("todate",  "---" + todate.getText().toString());
        ...
        Log.w("fromdate",   "---" + fromdate.getText().toString());
       ...
       new GetEmp().execute();
        ...
        final DatePickerDialog.OnDateSetListener date_form = new DatePickerDialog.OnDateSetListener() {
            ...
            private void updateLabel() {
                ...
                Toast.makeText(getApplicationContext(), "from date clicked" + " fromdate change clicked" , Toast.LENGTH_LONG).show();
            }
        ...
        fromdate.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new DatePickerDialog(AmDoctorDailyReport.this, date_form, myCalendar.get(Calendar.YEAR), myCalendar.get(Calendar.MONTH),
        ...
        mpo.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                String mpoforam=mar[1].trim();


                Log.e("doctorforam ", "> " +mpo.getSelectedItem().toString());
                Log.e("doctorforamcode ", "> " + mpoforam);
        ...
        final DatePickerDialog.OnDateSetListener date_to = new DatePickerDialog.OnDateSetListener() {
            ...
            private void updateLabel() {
                ...
                Toast.makeText(getApplicationContext(), "to date clicked" + "date change clicked" , Toast.LENGTH_LONG).show();
            }
        ...
        todate.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new DatePickerDialog(AmDoctorDailyReport.this, date_to, myCalendar
                ...
                Thread backthred = new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            Intent i = new Intent(AmDoctorDailyReport.this,  AmReportDashboard.class);
        ...
        submitBtn_2.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(final View v) {
                try {
                    ...
                    System.out.println("mpoforamsubmit2"+mpoforam);

                    Log.e("mpoforamsubmit2","mpoforam"+mpoforam);
	...
	*/
    ...
    class Spinner {
        ...
        private void populateSpinner() {
            ...
            AmDoctorDcrReportValAdapter adapter = new AmDoctorDcrReportValAdapter(AmDoctorDailyReport.this,sl,lables, quanty, value,value4,value5,value6,value7);
    ...
    private class GetCategories extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(AmDoctorDailyReport.this);
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            if (json != null) {
                ...
                Toast.makeText(AmDoctorDailyReport.this, "Nothing To Disply",Toast.LENGTH_SHORT).show();
                Toast.makeText(AmDoctorDailyReport.this, "Please make a order first !",Toast.LENGTH_LONG).show();
            }
            return null;
        }
        @Override
...
*/
    ...
    class GetEmp extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog2 = new ProgressDialog(AmDoctorDailyReport.this);
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            List<NameValuePair>params=new ArrayList<NameValuePair>();
            params.add(new BasicNameValuePair("id",id));
            params.add(new BasicNameValuePair("fromdate1",fromdate1));
            params.add(new BasicNameValuePair("todate1",todate1));
            ServiceHandler jsonParser=new ServiceHandler();
    ...
    private void view() {
        Intent i = new Intent(AmDoctorDailyReport.this, AmReport.class);
        startActivity(i);
        finish();
