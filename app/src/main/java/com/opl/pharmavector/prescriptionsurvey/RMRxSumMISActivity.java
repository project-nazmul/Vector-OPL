...
public class RMRxSumMISActivity extends Activity implements RxSummaryMISAdapter.RxSummaryMisListener {
    ...
    private void initCalender() {
        ...
        fromdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new DatePickerDialog(RMRxSumMISActivity.this, date_form, myCalendar.get(Calendar.YEAR), myCalendar.get(Calendar.MONTH),
        ...
        todate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new DatePickerDialog(RMRxSumMISActivity.this, date_to, myCalendar
            ...
            public void afterTextChanged(final Editable s) {
                try {
                    ...
                    if (inputorder.contains("-")) {
                        ...
                        KeyboardUtils.hideKeyboard(RMRxSumMISActivity.this);
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
    ...
    private void getRxSumMisDetailLists() {
        ...
        ProgressDialog pDialog = new ProgressDialog(RMRxSumMISActivity.this);
        ...
        call.enqueue(new Callback<RxSumMISSelfModel>() {
            ...
            public void onResponse(Call<RxSumMISSelfModel> call, Response<RxSumMISSelfModel> response) {
                if (response.isSuccessful()) {
                    ...
                    LinearLayoutManager linearLayoutManager = new LinearLayoutManager(RMRxSumMISActivity.this);
                    rxSumMISDetailAdapter = new RxSummaryMISAdapter(RMRxSumMISActivity.this, rxSumMISDetailLists, RMRxSumMISActivity.this, data_checker);
                    recyclerRxSumDetail.setLayoutManager(linearLayoutManager);
                    recyclerRxSumDetail.setAdapter(rxSumMISDetailAdapter);
                    recyclerRxSumDetail.addItemDecoration(new DividerItemDecoration(RMRxSumMISActivity.this, DividerItemDecoration.VERTICAL));
        ...
        call.enqueue(new Callback<RxSumMISSelfModel>() {
            ...
            public void onResponse(Call<RxSumMISSelfModel> call, Response<RxSumMISSelfModel> response) {
                if (response.isSuccessful()) {
                    ...
                    linearLayoutManager = new LinearLayoutManager(RMRxSumMISActivity.this);
                    rxSumMISSelfAdapter = new RxSummaryMISAdapter(RMRxSumMISActivity.this, rxSumMISSelfLists, RMRxSumMISActivity.this, data_checker);
    ...
    public void onRxMisClick(int position, RxSumMISSelfList rxModel) {
        Intent intent = new Intent(RMRxSumMISActivity.this, AMRxSumMISActivity.class);
