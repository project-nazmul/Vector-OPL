...
public class RXShowAdapter extends BaseAdapter {
    TextView serial;
    CheckBox check;
    Context mContext;
    ...
    RXShowAdapter(Context con, ArrayList<String> product_name, ArrayList<Integer> qnty, ArrayList<String> value,
    ...
    public RXShowAdapter(Context con, ArrayList<String> product_name, ArrayList<Integer> qnty, ArrayList<String> value,
                         ArrayList<String> achv, ArrayList<String> growth, ArrayList<String> mpo_code,
                         ArrayList<String> rtarget,
                         ArrayList<String> sgtarget,
                         ArrayList<String> bltarget,
    ...
    public Object getItem(int position) {
        // TODO Auto-generated method stub
        return (product_name.get(position)+"/"+ mpo_code.get(position));
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        rowView = inflater.inflate(R.layout.adapter_rx_report, parent, false);
