 ...
 import com.opl.pharmavector.adapter.CategoryAdapter9;
 import com.opl.pharmavector.model.Category;
 import com.opl.pharmavector.serverCalls.FavouriteCategoriesJsonParser;
 import com.opl.pharmavector.serverCalls.FavouriteCategoriesJsonParser11;
 ...
 public class PendingProposalDoc extends AppCompatActivity {
     Context context;
     ArrayList<Category> array_list;
     FavouriteCategoriesJsonParser11 categoryJsonParser;
     ...
     private String pc_conference_submit = BASE_URL+"pending_pc_conference_submit.php";
     ...
     protected void onCreate(Bundle savedInstanceState) {
         ...
         conf_type_val = "P";
         pending_month = b.getString("pending_month");
         final String UserName_2 = b.getString("UserName_2");
         Log.w("pending_month", pending_month + "---" + pending_month+"----"+ UserName_2);
         user_show.setText(UserName+ " "+ UserName_2 +" "  );
         Log.e("venue_charge",venue_charge);
         Log.e("pending_month",pending_month);
         ...
         TOTAL_BUDGET= String.valueOf(result);

         Log.e("TOTAL_BUDGET",TOTAL_BUDGET+"--TOTAL_BUDGET--"+TOTAL_BUDGET+"--TOTAL_BUDGET--"+TOTAL_BUDGET+"--TOTAL_BUDGET---"+TOTAL_BUDGET);
         ...
         button.setOnClickListener(new View.OnClickListener() {
             public void onClick(View v) {
                 categoriesCsv = FavouriteCategoriesJsonParser11.selectedCategories.toString();
                 categoriesCsv = categoriesCsv.substring(1, categoriesCsv.length() - 1);
                 categoriesPhone = FavouriteCategoriesJsonParser11.selectedphonenumber.toString();
                 ...
                 if (categoriesCsv.length() < 0) {
                     ...
                     Thread server = new Thread(new Runnable() {
                         ...
                         public void run() {
                             ...
                             //  params.add(new BasicNameValuePair("product_list", product_list));
                             ...
                             params.add(new BasicNameValuePair("pending_month", pending_month));
                             ...
                             Intent sameint = new Intent(PendingProposalDoc.this, PCPendingProposal.class);
     ...
     public class asyncTask_getCategories extends AsyncTask<Void, Void, Void> {
         ...
         protected void onPreExecute() {
             ...
             my_val=UserName;
             categoryJsonParser = new FavouriteCategoriesJsonParser11();
         ...
         protected void onPostExecute(Void s) {
             ...
             final CategoryAdapter9 categoryAdapter9 = new CategoryAdapter9(context, R.layout.row_category, array_list);
             mListViewBooks.setAdapter(categoryAdapter9);
