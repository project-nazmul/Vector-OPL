...
public class AmChemistGiftOrder extends Activity implements OnClickListener {
    ...
    com.opl.pharmavector.AmChemistGiftListAdapter adapter2;
    Button submit;
    ...
    int textlength = 0;
    com.opl.pharmavector.AmChemistGiftListAdapter adapter;
    ...
    public static String URL_NEW_CATEGORY = BASE_URL_AM+"4.php";
    private String URL_CATEGORIES = BASE_URL_AM+"get_chem_gift.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.amchemistgiftorder);
        ...
        mic.setText("\uf130");
        toast1 = Toast.makeText(AmChemistGiftOrder.this, "Please select Order Quantity  !!!.", Toast.LENGTH_LONG);
        ...
        com.opl.pharmavector.AmChemistGiftListAdapter.qnty = null;
        com.opl.pharmavector.AmChemistGiftListAdapter.qntyID.clear();
        com.opl.pharmavector.AmChemistGiftListAdapter.qntyVal.clear();
    ...
    public void swapfocus(View v){
        //	ChemistGiftListAdapter.focusvalue=0;
        if (com.opl.pharmavector.AmChemistGiftListAdapter.focusvalue==0) {
            v.clearFocus();
            searchview.setFocusable(true);

            Log.e("FocusVal", ""+ com.opl.pharmavector.AmChemistGiftListAdapter.focusvalue);
...
// RXListAdapter
    ...
    protected void onResume() {
        // TODO Auto-generated method stub
        // System.out.println("EditTxtID " + ChemistGiftListAdapter.editTxtID.size());
        super.onResume();
    ...
    private void populateSpinner() {
        ...
        adapter = new com.opl.pharmavector.AmChemistGiftListAdapter(AmChemistGiftOrder.this, sl, lables, mapQuantity);
    ...
    private class GetCategories extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(AmChemistGiftOrder.this);
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            final   String CHEM_CODE = extra.getString("CHEM_CODE");
       ...
       //     Log.v("Order_number ", "> " + "Order_number :"+ord_no);
            ...
            Log.w("giftpageCHEM_CODE ", "> " + CHEM_CODE);
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == submit.getId()) {
            ...
            Toast.makeText(getBaseContext(), "Chemist Gift Submit clicked", Toast.LENGTH_SHORT).show();
            ...
            if (com.opl.pharmavector.AmChemistGiftListAdapter.qntyID.size() < 1) {
                Toast.makeText(this, "No item inserted", Toast.LENGTH_SHORT).show();
            }
            else {

             //   Log.e("value2 Chesize()", "  "+ ChemistGiftListAdapter.qntyID.size());
              ...
              /// Toast.makeText(this, " item inserted-----else------", Toast.LENGTH_LONG).show();
                ...
                for (int i = 1; i <= ChemistGiftListAdapter.p_quanty.size(); i++) {
                   ...
                   // int value2 = Integer.parseInt(ChemistGiftListAdapter.p_quanty.get(i-1));
                    Log.e("index value", "  "+ i);
                    Log.e("value", "  "+ value);

                   // Log.e("value2", "  "+ value2);
                //    Toast.makeText(this, "ChemistGiftListAdapter.p_quanty.get(i) = " + value, Toast.LENGTH_LONG).show();
                    ...
                    if (value>0) {
                        ...
                        System.out.println("ORD_QNTY"+String.valueOf(k)+"="+ ChemistGiftListAdapter.p_quanty.get(i));
                        ...
                        Log.w("ORD_QNTY", " Number of Products ordered value : "+ ChemistGiftListAdapter.p_quanty.get(i));
                ...
                Log.e("AM_PM", "> " + AM_PM);
                Log.e("TOUR_NATURE", "> " + location_code);
                Log.e("doc code", "> " + doc_code);
                Log.e("VISIT_DATE", "> " + VISIT_DATE);
                Log.e("Visited with ", "> " + Visitor_Code);
...
//                                    SaveToDataBase();
                            ...
                            Intent sameint = new Intent(AmChemistGiftOrder.this, AmDcr.class);
        ...
        if (v.getId() == calc.getId()) {
            ...
            int total_item = com.opl.pharmavector.AmChemistGiftListAdapter.p_quanty.size();
            // System.out.println("total_item " + total_item);
            for (int i = 1; i < total_item; i++) {
                int value = Integer.parseInt(com.opl.pharmavector.AmChemistGiftListAdapter.p_quanty.get(i));
                // System.out.println("value " + value);
                if (value > 0) {
                    qnty1 = Integer.parseInt(com.opl.pharmavector.AmChemistGiftListAdapter.p_quanty.get(i));
