...
public class RMfollowMpoAchv extends Activity implements OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    private String URL_PRODUCT_VIEW = BASE_URL+"salesfollowupreport/RMfollowMpoAchv.php";
                ...
                Thread backthred = new Thread(new Runnable() {
                    ...
                    public void run() {
                        try {
                            ...
                            Intent i = new Intent(RMfollowMpoAchv.this, RmSalesReportDashboard.class);
    ...
    private void initCalendar() {
        ...
        todate.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                new DatePickerDialog(RMfollowMpoAchv.this, date_to, myCalendar
    ...
    class LoadProduct extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(RMfollowMpoAchv.this);
    ...
    private class GetCategories extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            if (pDialog.isShowing())
                pDialog.dismiss();
            RMfollowMpoAchv.Spinner sp = new RMfollowMpoAchv.Spinner();
            sp.populateSpinner();
            popSpinner();
            totqty.setText("");
            totval.setText("");
    ...
    private void view() {
        Intent i = new Intent(RMfollowMpoAchv.this, com.opl.pharmavector.Report.class);
        startActivity(i);
        finish();
