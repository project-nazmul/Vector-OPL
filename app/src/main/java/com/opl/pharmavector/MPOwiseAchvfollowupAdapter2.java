...
public class MPOwiseAchvfollowupAdapter2 extends BaseAdapter {
    TextView serial;
    //TextView p_name;
    //EditText quanty;
    CheckBox check;
    ...
    MPOwiseAchvfollowupAdapter2(Context con, ArrayList<String> product_name, ArrayList<String> qnty, ArrayList<String> value, ArrayList<String> achv, String mpo_code) {
    ...
    MPOwiseAchvfollowupAdapter2(Context con, ArrayList<String> product_name, ArrayList<String> qnty, ArrayList<String> value, ArrayList<String> achv, ArrayList<String> mpo_code, ArrayList<String> mpo_name) {
        this.product_name = product_name;
        this.qnty = qnty;
        this.value = value;
        this.achv = achv;
    ...
    MPOwiseAchvfollowupAdapter2(Context con, ArrayList<String> product_name, ArrayList<String> qnty, ArrayList<String> value, ArrayList<String> achv, ArrayList<String> mpo_code, ArrayList<String> mpo_name, ArrayList<String> growth_val, ArrayList<String> mon_val, ArrayList<String> cum_growth) {
        this.product_name = product_name;
        this.qnty = qnty;
        this.value = value;
        this.achv = achv;
...
//            rowView = inflater.inflate(R.layout.amviewbydateproduct_show2, parent, false);
//        } else {
//            rowView = inflater.inflate(R.layout.amviewbydateproduct_show0, parent, false);
//        }
        ...
        holder.y_growth = (TextView) rowView.findViewById(R.id.y_growth);
        ...
        holder.y_growth.setText(cum_growth.get(position));
    ...
    private class ViewHolder {
        ...
        TextView mpo_code;
        TextView mpo_name;
        TextView growth_val, growth_mon, y_growth;
        TextView achv;
        //int click_pos;
        //int last_position;
    }
