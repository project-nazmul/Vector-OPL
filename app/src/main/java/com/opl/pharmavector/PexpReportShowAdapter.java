 ...
 public class PexpReportShowAdapter extends BaseAdapter {
...
*/
     ...
     PexpReportShowAdapter(Context con, ArrayList<String> product_name, ArrayList<String> qnty_report, ArrayList<String> value_3) {
         this.product_name = product_name;
     ...
     PexpReportShowAdapter(Context con, ArrayList<String> product_name, ArrayList<String> qnty_report, ArrayList<String> value_3,ArrayList<String> value_4) {
         this.product_name = product_name;
         this.qnty = qnty_report;
         this.value = value_3;
         this.value4 = value_4;
     ...
     PexpReportShowAdapter(Context con, ArrayList<String> product_name, ArrayList<String> qnty_report, ArrayList<String> value_3,ArrayList<String> value_4,ArrayList<String> value_5) {
         this.product_name = product_name;
         this.qnty = qnty_report;
         this.value = value_3;
         this.value4 = value_4;
     ...
     PexpReportShowAdapter(Context con,ArrayList<String> sl, ArrayList<String> product_name, ArrayList<String> qnty_report, ArrayList<String> value_3,
