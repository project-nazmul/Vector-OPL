...
public class FMDcfpFollowupActivity extends Activity implements DcfpFollowupAdapter.DcfpClickListener {
    ...
    private void calenderInit() {
        ...
        tvfromdate.setOnClickListener(v -> new DatePickerDialog(FMDcfpFollowupActivity.this, date_form, myCalendar.get(Calendar.YEAR), myCalendar.get(Calendar.MONTH),
        ...
        tvtodate.setOnClickListener(v -> new DatePickerDialog(FMDcfpFollowupActivity.this, date_to, myCalendar
                .get(Calendar.YEAR), myCalendar.get(Calendar.MONTH),
                myCalendar1.get(Calendar.DAY_OF_MONTH)).show());
    }

    public void dcrDcfpFollowupInfo() {
        ProgressDialog dcfpFollowDialog = new ProgressDialog(FMDcfpFollowupActivity.this);
        ...
        call.enqueue(new Callback<List<DcrFollowupModel>>() {
            ...
            public void onResponse(@NonNull Call<List<DcrFollowupModel>> call, @NonNull retrofit2.Response<List<DcrFollowupModel>> response) {
                ...
                if (dcfpFollowupList.size() > 0) {
                    ...
                    dcfpFollowupAdapter = new DcfpFollowupAdapter(FMDcfpFollowupActivity.this, dcfpFollowupList, FMDcfpFollowupActivity.this, userRole);
                    LinearLayoutManager manager = new LinearLayoutManager(FMDcfpFollowupActivity.this);
                    dcfpFollowupRecycler.setLayoutManager(manager);
                    dcfpFollowupRecycler.setAdapter(dcfpFollowupAdapter);
                    dcfpFollowupRecycler.addItemDecoration(new DividerItemDecoration(FMDcfpFollowupActivity.this, DividerItemDecoration.VERTICAL));
                } else {
                    dcfpFollowDialog.dismiss();
                    Toast.makeText(FMDcfpFollowupActivity.this, "No data Available!", Toast.LENGTH_LONG).show();
                }
            }
    ...
    public void onDcfpClick(int position, DcrFollowupModel model) {
        if (Objects.equals(userRole, "D")) {
            Intent intent = new Intent(FMDcfpFollowupActivity.this, MPODcfpFollowupActivity.class);
