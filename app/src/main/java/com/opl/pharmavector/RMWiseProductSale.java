...
public class RMWiseProductSale extends Activity implements OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    private String URL_PRODUCT_VIEW =BASE_URL+"productwisesales/RMWiseProductSale.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                ...
                Intent i = new Intent(RMWiseProductSale.this, FMwiseProductSale.class);
                ...
                Log.i("RMTOFM", p_code +"--RMTOFM--"+product_name);
                startActivity(i);
            }
        });
        ...
        fromdate.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new DatePickerDialog(RMWiseProductSale.this, date_form, myCalendar.get(Calendar.YEAR), myCalendar.get(Calendar.MONTH),
        ...
        todate.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new DatePickerDialog(RMWiseProductSale.this, date_to, myCalendar
...
/*
                            ...
                            Intent i = new Intent(RMWiseProductSale.this,AdminReportDashboard.class);
    ...
    class LoadProduct extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(  RMWiseProductSale.this);
    ...
    class Spinner {
        ...
        private void populateSpinner() {
            ...
            for (int i = 0; i < categoriesList.size(); i++) {
                ...
                Log.w("prod_rate",prod_rate);
                Log.w("prod_vat",prod_vat);
                Log.w("ppm_code",ppm_code);


                Log.w("shift_code",shift_code);
 ...
 */
            ...
            // MPOwiseProductSaleShowAdapter adapter = new MPOwiseProductSaleShowAdapter(RMWiseProductSale.this,lables, quanty,value,achv,mpo_code);

            //  BrandwiseProductShowAdapter adapter = new BrandwiseProductShowAdapter(RMWiseProductSale.this,lables, quanty,value,achv,mpo_code);
    ...
    private class GetCategories extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            if (json != null) {
                ...
                Log.e("JSON Data", "Didn't receive any data from server!");
                Toast.makeText(RMWiseProductSale.this, "Nothing To Disply",Toast.LENGTH_SHORT).show();
                Toast.makeText(RMWiseProductSale.this, "Please make a order first !",Toast.LENGTH_LONG).show();
            }
            return null;
        }
        @Override
        protected void onPostExecute(Void result) {
            ...
            if (pDialog.isShowing())
                pDialog.dismiss();
            RMWiseProductSale.Spinner sp = new RMWiseProductSale.Spinner();
            sp.populateSpinner();
            popSpinner();
            totqty.setText("");
            totval.setText("");
    ...
    private void view() {
        Intent i = new Intent(RMWiseProductSale.this, com.opl.pharmavector.Report.class);
        startActivity(i);
        finish();
