...
public class Viewbycustomer extends Activity implements OnClickListener {
    ...
    public String CurrenCustomer = "", FROM_DATE, TO_DATE;
    ...
    private String URL_PRODUCT_VIEW = BASE_URL+"mposalesreports/depo_report/ord_vs_sale_qnty.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.viewbycustomer);
        initViews();
        calenderinitViews();
            ...
            public void onClick(final View v) {
                try {
                    ...
                    if (fromdate1.isEmpty() || (fromdate1.equals("From Date"))) {
                        ...
                        new GetCategories().execute();//new GetCategories2().execute();
                    }
    ...
    private void initViews() {
        ...
        ordspin2 = findViewById(R.id.ord);
    ...
    private void calenderinitViews() {
        ...
        FROM_DATE = current_fromdate;
        TO_DATE = current_todate;
        ...
        fromdate.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new DatePickerDialog(Viewbycustomer.this, date_form, myCalendar.get(Calendar.YEAR), myCalendar.get(Calendar.MONTH),
        ...
        todate.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new DatePickerDialog(Viewbycustomer.this, date_to, myCalendar
    ...
    class Spinner {
        ...
        private void populateSpinner() {
            ...
            ViewbycustomerProductShowAdapterorder adapter = new ViewbycustomerProductShowAdapterorder(Viewbycustomer.this, lables, quanty, value);
    ...
    private class GetCategories extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Viewbycustomer.this);
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            if (json != null) {
                ...
                Toast.makeText(Viewbycustomer.this, "Nothing To Disply", Toast.LENGTH_SHORT).show();
                Toast.makeText(Viewbycustomer.this, "Please make a order first !", Toast.LENGTH_LONG).show();
            }
            return null;
        }
    ...
    private void view() {
        Intent i = new Intent(Viewbycustomer.this, Report.class);
        startActivity(i);
        finish();
