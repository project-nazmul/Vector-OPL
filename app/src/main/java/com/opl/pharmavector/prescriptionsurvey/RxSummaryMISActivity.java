...
import com.opl.pharmavector.dcfpFollowup.AMDcfpFollowupActivity;
import com.opl.pharmavector.dcfpFollowup.DoctorReachActivity;
import com.opl.pharmavector.dcfpFollowup.DoctorReachAdapter;
import com.opl.pharmavector.dcfpFollowup.DoctorReachSelfList;
import com.opl.pharmavector.dcfpFollowup.RMDcfpFollowupActivity;
...
public class RxSummaryMISActivity extends Activity implements RxSummaryMISAdapter.RxSummaryMisListener {
    ...
    public void onRxMisClick(int position, RxSumMISSelfList rxModel) {
        ...
        intent.putExtra("ff_code", rxModel.getFfCode());
