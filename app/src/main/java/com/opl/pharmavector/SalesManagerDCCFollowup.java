...
public class SalesManagerDCCFollowup extends Activity implements OnClickListener {
    ...
    public String message, ord_no, asm_code, sm_code, gm_code, gm_flag, sm_flag;
    ...
    private String URL_DETAIL_VIEW = BASE_URL_AM + "assistant_manager_dcc_campaign/sales_manager_dcc_master.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sm_code = b.getString("UserName");

        gm_code = b.getString("gm_code");
        gm_flag = b.getString("gm_flag");
        sm_flag = b.getString("sm_flag");

        //Toast.makeText(SalesManagerDCCFollowup.this, "SALES MANAGER DCC FOLLOWUP"+gm_flag, Toast.LENGTH_LONG).show();
        ...
        productListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                ...
                Intent i = new Intent(SalesManagerDCCFollowup.this, AssistantManagerDCCFollowup.class);
                ...
                Log.w("GOTO-ASSISTANTMANAGER", gm_code + "- gm_code gm_code --" + gm_code + "--gm_flag--" + gm_flag);
                startActivity(i);
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            if (gm_flag.equals("Y")) {
                                ...
                                Intent i = new Intent(SalesManagerDCCFollowup.this, GMDCCFollowup.class);
                                i.putExtra("UserName", gm_code);
                                i.putExtra("new_version", gm_code);
                                i.putExtra("UserName_1", gm_code);
                                i.putExtra("UserName_2", gm_code);
                                i.putExtra("gm_code", gm_code);
                                i.putExtra("gm_flag", gm_flag);
                                ...
                                Intent i = new Intent(SalesManagerDCCFollowup.this, SalesManagerDashboard.class);
                                ...
                                Log.d("SALESMANAGERDCC-BACK", "UserName" + userName);
        ...
        detail.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                pDialog = new ProgressDialog(SalesManagerDCCFollowup.this);
    ...
    class Spinner {
        ...
        private void populateSpinner() {
            ...
            DccCampAdapter adapter = new DccCampAdapter(SalesManagerDCCFollowup.this, sl, lables, quanty, value, value4, value5, value6, value7, value8, value9, value10, value11, value12);
    ...
    class Spinner2 {
        ...
        private void populateSpinner2() {
            ...
            DccCampAdapter adapter2 = new DccCampAdapter(SalesManagerDCCFollowup.this, sl, lables, quanty, value, value4, value5, value6, value7, value8, value9, value10, value11, value12);
    ...
    private class January extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(SalesManagerDCCFollowup.this);
            pDialog.setTitle("Sales Manager Data !");
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            if (json != null) {
                ...
                Toast.makeText(SalesManagerDCCFollowup.this, "Nothing To Disply", Toast.LENGTH_SHORT).show();
                Toast.makeText(SalesManagerDCCFollowup.this, "Please make a order first !", Toast.LENGTH_LONG).show();
            }
            return null;
        }
    ...
    private void view() {
        Intent i = new Intent(SalesManagerDCCFollowup.this, Report.class);
        startActivity(i);
        finish();
