...
public class AssistantManagerDCCFollowup extends Activity implements OnClickListener {
    ...
    public String message, ord_no, asm_code, sm_code, gm_code, sm_flag, gm_flag;
    TextView date2, ded, fromdate, todate, detail_head, user_id;
    int textlength = 0;
    ...
    private final String URL_DETAIL_VIEW = BASE_URL_AM + "assistant_manager_dcc_campaign/assistant_manager_dcc_master.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //   Toast.makeText(AssistantManagerDCCFollowup.this, userName, Toast.LENGTH_LONG).show();
        // Toast.makeText(AssistantManagerDCCFollowup.this, gm_flag, Toast.LENGTH_LONG).show();
        ...
        productListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                ...
                Intent i = new Intent(AssistantManagerDCCFollowup.this, RmDCCFollowup.class);


                i.putExtra("UserName", rm_code);
                i.putExtra("UserName_2", rm_code);
                ...
                Log.w("GOTO--RMDCCFOLLOWUP", sm_flag + "------- sm_flag -------" + sm_code + "--sm_code--" + gm_code + "------ gm_code  --------" + gm_flag);
                startActivity(i);
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            if (sm_flag.equals("Y")) {
                                ...
                                Intent i = new Intent(AssistantManagerDCCFollowup.this, SalesManagerDCCFollowup.class);
                                i.putExtra("UserName", sm_code);
                                i.putExtra("new_version", sm_code);
                                i.putExtra("UserName_1", sm_code);
                                ...
                                Log.w("BACKDCCFOLLOWUP---SM", sm_flag + "------- sm_flag -------" + sm_code + "--sm_code--" + gm_code + "------ gm_code  --------" + gm_flag);
                                ...
                                Intent i = new Intent(AssistantManagerDCCFollowup.this, AssistantManagerDashboard.class);
        ...
        detail.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                pDialog = new ProgressDialog(AssistantManagerDCCFollowup.this);
                ...
                Thread backthred = new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            Intent i = new Intent(AssistantManagerDCCFollowup.this, AmDCCFollowupnew.class);
                            i.putExtra("UserName", userName);
                            i.putExtra("new_version", userName);
                            i.putExtra("UserName_1", UserName_1);
                            i.putExtra("UserName_2", UserName_2);
    ...
    class Spinner {
        ...
        private void populateSpinner() {
            ...
            DccCampAdapter adapter = new DccCampAdapter(AssistantManagerDCCFollowup.this, sl, lables, quanty, value, value4, value5, value6, value7, value8, value9, value10, value11, value12);
    ...
    class Spinner2 {
        ...
        private void populateSpinner2() {
            ...
            DccCampAdapter adapter2 = new DccCampAdapter(AssistantManagerDCCFollowup.this, sl, lables, quanty, value, value4, value5, value6, value7, value8, value9, value10, value11, value12);
    ...
    class Spinner3 {
        ...
        private void populateSpinner3() {
            ...
            DccCampAdapter adapter3 = new DccCampAdapter(AssistantManagerDCCFollowup.this, sl, lables, quanty, value, value4, value5, value6, value7, value8, value9, value10, value11, value12);
    ...
    class Spinner4 {
        ...
        private void populateSpinner4() {
            ...
            DccCampAdapter adapter4 = new DccCampAdapter(AssistantManagerDCCFollowup.this, sl, lables, quanty, value, value4, value5, value6, value7, value8, value9, value10, value11, value12);
    ...
    class Spinner5 {
        ...
        private void populateSpinner5() {
            ...
            DccCampAdapter adapter5 = new DccCampAdapter(AssistantManagerDCCFollowup.this, sl, lables, quanty, value, value4, value5, value6, value7, value8, value9, value10, value11, value12);
    ...
    private class January extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(AssistantManagerDCCFollowup.this);
            pDialog.setTitle("Assistant Manager Data Loading !");
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            if (json != null) {
                ...
                Toast.makeText(AssistantManagerDCCFollowup.this, "Nothing To Disply", Toast.LENGTH_SHORT).show();
                Toast.makeText(AssistantManagerDCCFollowup.this, "Please make a order first !", Toast.LENGTH_LONG).show();
            }
            return null;
        }
    ...
    private void view() {
        Intent i = new Intent(AssistantManagerDCCFollowup.this, Report.class);
        startActivity(i);
        finish();
