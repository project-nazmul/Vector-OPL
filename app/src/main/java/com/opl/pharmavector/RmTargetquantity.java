...
import com.opl.pharmavector.adapter.RmTargetquantityProductShowAdapter;
...
public class RmTargetquantity extends Activity implements OnClickListener {
    ...
    private String URL_PRODUCT_VIEW = BASE_URL+"regional_manager_api/sales_reports/Targetquantitygrowth.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rmtargetquantity);
        initViews();
        initCalender();
        ...
        todate.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new DatePickerDialog(RmTargetquantity.this, date_to, myCalendar
                ...
                Thread backthred = new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            Intent i = new Intent(RmTargetquantity.this, RmSalesReportDashboard.class);
    ...
    private void initCalender() {
        ...
        fromdate.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new DatePickerDialog(RmTargetquantity.this, date_form, myCalendar.get(Calendar.YEAR), myCalendar.get(Calendar.MONTH),
    ...
    private void initViews() {
        ...
        view_btn = (Button) findViewById(R.id.view);
    ...
    class Spinner {
        ...
        private void populateSpinner() {
            ...
            RmTargetquantityProductShowAdapter adapter = new RmTargetquantityProductShowAdapter(RmTargetquantity.this, lables, quanty, value, achv, growth);
    ...
    private class GetCategories extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(RmTargetquantity.this);
            pDialog.setTitle("Sales Data Loading !");
            pDialog.setMessage("Calculating Sales Data");
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            if (json != null) {
                ...
                Toast.makeText(RmTargetquantity.this, "Nothing To Disply", Toast.LENGTH_SHORT).show();
            }
            return null;
        }
        ...
        protected void onPostExecute(Void result) {
            ...
            if (pDialog.isShowing())
                pDialog.dismiss();
            RmTargetquantity.Spinner sp = new RmTargetquantity.Spinner();
            sp.populateSpinner();
            popSpinner();
            totqty.setText("");
            totval.setText("");
    ...
    private void view() {
        Intent i = new Intent(RmTargetquantity.this, com.opl.pharmavector.Report.class);
        startActivity(i);
        finish();
