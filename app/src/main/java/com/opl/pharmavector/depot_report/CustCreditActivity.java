...
import com.opl.pharmavector.Viewbycustomerorderstatus;
...
public class CustCreditActivity extends Activity {
    ...
    final String URL_PRODUCT_VIEW = BASE_URL+"mposalesreports/depo_report/credit_customer_info.php";
    final String URL_CUSOTMER = BASE_URL+"mposalesreports/depo_report/credit_customer_list.php";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.depot_cust_credit);
        initViews();
        initCalender();
    ...
    private void initCalender() {
        ...
        fromdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new DatePickerDialog(CustCreditActivity.this, date_form, myCalendar.get(Calendar.YEAR), myCalendar.get(Calendar.MONTH),
        ...
        todate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new DatePickerDialog(CustCreditActivity.this, date_to, myCalendar
    ...
    private class GetCustomer extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(CustCreditActivity.this);
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            if (json != null) {
                ...
                Toast.makeText(CustCreditActivity.this, "Nothing To Display", Toast.LENGTH_SHORT).show();
            }
            return null;
        }
        @Override
    ...
    private void dataload() {
        ...
        Call<ArrayList<RecyclerData>>  call = apiInterface.getCustCredit(userName, p_cust_code);
            ...
            public void onResponse(Call<ArrayList<RecyclerData>> call, Response<ArrayList<RecyclerData>> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    for (int i = 0; i < recyclerDataArrayList.size(); i++) {
                        recyclerViewAdapter = new RecycleViewAdapter(CustCreditActivity.this,recyclerDataArrayList);

                        LinearLayoutManager manager = new LinearLayoutManager(CustCreditActivity.this, LinearLayoutManager.VERTICAL, true);
