...
public class TargetquantityProductShowAdapter extends BaseAdapter {
	TextView serial;
	// TextView p_name;
	// EditText quanty;
	CheckBox check;
...
//	public static String qnty;
	...
	TargetquantityProductShowAdapter(Context con, ArrayList<String> product_name,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		rowView = inflater.inflate(R.layout.viewbytargetquantity_show, parent, false);
