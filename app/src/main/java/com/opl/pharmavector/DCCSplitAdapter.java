...
public class DCCSplitAdapter extends BaseAdapter implements Filterable {
    ...
    public DCCSplitAdapter(Activity activity,
    ...
    DCCSplitAdapter(Context con, ArrayList<String> sl,
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        int srl = MPODCCSplit.nameSerialPair.get(holder.p_name.getText().toString());
        ...
        holder.quantity.setOnTouchListener(new OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                MPODCCSplit.searchview.setFocusable(false);
                ...
                try {
                    ...
                    if (str.toString().isEmpty()) {
                        ...
                        for (Iterator i = keys.iterator(); i.hasNext();) {
                            ...
                            String product_rate = MPODCCSplit.categoriesList.get(key).getPROD_RATE();
                        ...
                        MPODCCSplit.totalsellquantity.setText("" + tota);
                        ...
                        if (checkZero > 0) {
                            ...
                            for (Iterator i = keys.iterator(); i.hasNext();) {
                                ...
                                String product_rate = MPODCCSplit.categoriesList
                                        .get(8).getPROD_RATE();
        ...
        holder.quantity.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                ...
                //return false;
					/*	if (focusvalue==0) {
							MPODCCSplit.searchview.requestFocus();
							holder.quantity.clearFocus();

						}else {
							holder.quantity.requestFocus();
							MPODCCSplit.searchview.clearFocus();;
                ...
                if (!hasFocus) {
                    ...
                    //MPODCCSplit.searchview.setFocusable(true);
                    //	holder.quantity.clearFocus();
                    //	MPODCCSplit.searchview.requestFocus();
                    focusvalue=0;
                    ...
                    focusvalue=1;
                    Log.i("focusvalue", ""+focusvalue);
                    //MPODCCSplit.searchview.setFocusableInTouchMode(false);
