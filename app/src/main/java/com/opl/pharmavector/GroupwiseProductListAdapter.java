...
public class GroupwiseProductListAdapter extends BaseAdapter implements Filterable {
    ...
    public GroupwiseProductListAdapter(Activity activity,
    ...
    GroupwiseProductListAdapter(Context con,ArrayList<String> sl, ArrayList<String> p_name,HashMap<Integer, String> p_quanty,ArrayList<String> value7,ArrayList<String> value8,ArrayList<String> value9,
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (rowView == null) {
            ...
            convertView = inflater.inflate(R.layout.grp_wise_prd_ord_list_adapter, null);
        ...
        final int srl = GroupwiseProductOrderSummary.nameSerialPair.get(holder.p_name.getText().toString());
...
/*
        holder.pack_size.setText(value9.get(srl)); // pack size
        holder.tp.setText(value10.get(srl)); // trade price
        holder.TP_VT.setText(value7.get(srl)); // vat
        holder.quantity.setText(value12.get(srl) ); //mrp value
        holder.p_code1.setText(value11.get(srl)); // product code
        holder.brand_code.setText(value8.get(srl)); // brand code
*/
...
/*
         if (value9.get(srl-1).toString().equals("GG")){
            holder.p_name.setTextColor(Color.rgb(237,237,237));
            holder.pack_size.setTextColor(Color.rgb(237,237,237));
        }
         */
