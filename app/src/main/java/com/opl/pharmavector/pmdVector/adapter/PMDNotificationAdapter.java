...
public class PMDNotificationAdapter extends BaseAdapter implements Filterable {
    ...
    public static HashSet<Integer> mProductSerialList;
    public static TextView edit_qnty;
    ArrayList<String> Data_Openingstock = new ArrayList<String>();
    public static HashMap<Integer, String> p_quanty;
    ...
    public PMDNotificationAdapter(Activity activity,
    ...
    public static ArrayList<Integer> qntyID = new ArrayList<Integer>();
    public static ArrayList<String> qntyVal = new ArrayList<String>();
    public static HashMap<Integer, String> dataSet = new HashMap<Integer, String>();
    ...
    public PMDNotificationAdapter(Context con, ArrayList<String> sl, ArrayList<String> p_name, HashMap<Integer, String> p_quanty, ArrayList<String> value7, ArrayList<String> value8) {
        this.p_names = p_name;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (rowView == null) {
            ...
            convertView = inflater.inflate(R.layout.adapter_pmd_noticeboard, null);
        ...
        int srl = PMDNotification.nameSerialPair.get(holder.p_name.getText().toString());
