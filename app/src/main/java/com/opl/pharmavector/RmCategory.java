...
public class RmCategory {
	...
	public RmCategory(String sl, String id, String name,int quantity,String PROD_RATE,String PROD_VAT,String PPM_CODE,String P_CODE,String SHIFT_CODE ){
		this.sl=sl;
		this.id = id;
		this.name = name;
	...
	public RmCategory(String sl, String id, String name,int quantity,String PROD_RATE,String PROD_VAT,String PPM_CODE,String P_CODE){
		this.sl=sl;
		this.id = id;
		this.name = name;
		this.quantity = quantity;
	...
	public RmCategory(String sl, String id, String name,int quantity,String PROD_RATE,String PROD_VAT,String PPM_CODE){
		this.sl=sl;
		this.id = id;
		this.name = name;
		this.quantity = quantity;
	...
	public RmCategory(String sl, String id, String name,int quantity,String PROD_RATE,String PROD_VAT){
		this.sl=sl;
		this.id = id;
		this.name = name;
		this.quantity = quantity;
