...
public class CategoryAdapter8 extends ArrayAdapter<Category> {
    private final List<Category> list;

    public CategoryAdapter8(Context context, int resource, List<Category> list) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            FavouriteCategoriesJsonParser10.selectedCategories.toString().equals("");
            ...
            viewHolder.categoryCheckBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                    ...
                    Log.e("getPositionvalues", FavouriteCategoriesJsonParser10.selectedCategories.toString());

                    list.get(getPosition).setSelected(buttonView.isChecked());
                    if (buttonView.isChecked()) {

                        if (!FavouriteCategoriesJsonParser10.selectedCategories.contains(String.valueOf(list.get(getPosition).getCateogry_id()))) {
                            FavouriteCategoriesJsonParser10.selectedCategories.add(String.valueOf(list.get(getPosition).getCateogry_id()));
                        ...
                        if (FavouriteCategoriesJsonParser10.selectedCategories.contains(String.valueOf(list.get(getPosition).getCateogry_id()))) {
                            FavouriteCategoriesJsonParser10.selectedCategories.remove(String.valueOf(list.get(getPosition).getCateogry_id()));
