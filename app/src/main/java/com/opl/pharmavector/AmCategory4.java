...
public class AmCategory4 {
    ...
    public AmCategory4(String sl, String id, String name,int quantity,String PROD_RATE,String PROD_VAT,String PPM_CODE){
        this.sl=sl;
        this.id = id;
        this.name = name;
    ...
    public AmCategory4(String sl, String id, String name,int quantity,String PROD_RATE,String PROD_VAT,String PPM_CODE,String P_CODE){
        this.sl=sl;
        this.id = id;
        this.name = name;
        this.quantity = quantity;
