 ...
 public class RMPexpReportShowAdapter extends BaseAdapter {
...
*/
     ...
     RMPexpReportShowAdapter(Context con, ArrayList<String> product_name, ArrayList<String> qnty_report, ArrayList<String> value_3) {
         this.product_name = product_name;
     ...
     RMPexpReportShowAdapter(Context con, ArrayList<String> product_name, ArrayList<String> qnty_report, ArrayList<String> value_3,ArrayList<String> value_4) {
         this.product_name = product_name;
         this.qnty = qnty_report;
         this.value = value_3;
         this.value4 = value_4;
     ...
     RMPexpReportShowAdapter(Context con, ArrayList<String> product_name, ArrayList<String> qnty_report, ArrayList<String> value_3,ArrayList<String> value_4,ArrayList<String> value_5) {
         this.product_name = product_name;
         this.qnty = qnty_report;
         this.value = value_3;
         this.value4 = value_4;
     ...
     RMPexpReportShowAdapter(Context con,ArrayList<String> sl, ArrayList<String> product_name, ArrayList<String> qnty_report, ArrayList<String> value_3,
     ...
     public View getView(int position, View convertView, ViewGroup parent) {
         ...
         rowView = inflater.inflate(R.layout.rmviewpersonalexpensesreport, parent, false);


         serial = (TextView) rowView.findViewById(R.id.serial);
         holder.product_name = (TextView) rowView.findViewById(R.id.rm_pex_mode);
         holder.sl = (TextView) rowView.findViewById(R.id.serial);

         holder.qnty = (TextView) rowView.findViewById(R.id.rm_pex_distance);

         holder.value = (TextView) rowView.findViewById(R.id.rm_pex_loc);
         holder.value4 = (TextView) rowView.findViewById(R.id.rm_pex_ta);
         holder.value5 = (TextView) rowView.findViewById(R.id.rm_pex_da);



         holder.value6 = (TextView) rowView.findViewById(R.id.rm_pex_other);
