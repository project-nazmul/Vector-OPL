...
public class GiftListAdapter2 extends BaseAdapter implements Filterable {
    ...
    public GiftListAdapter2(Activity activity,
    ...
    GiftListAdapter2(Context con, ArrayList<String> sl,
                    ArrayList<String> p_name, HashMap<Integer, String> p_quanty) {
    ...
    GiftListAdapter2(Context con,ArrayList<String> sl, ArrayList<String> p_name,HashMap<Integer, String> p_quanty,ArrayList<String> PROD_RATE,
                    ArrayList<String> PROD_VAT,
                    ArrayList<String> PPM_CODE ) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (rowView == null) {
            ...
            holder.product_quant = (TextView) convertView.findViewById(R.id.product_quant);

            holder.rest_quant = (TextView) convertView.findViewById(R.id.rest_quant);
        ...
        int srl = GiftOrder2.nameSerialPair.get(holder.p_name.getText().toString());
        ...
        holder.product_type.setText(PROD_VAT.get(position));

        Log.w("product_quant",PROD_VAT.get(position));



        holder.product_quant.setText(PROD_VAT.get(position));


        holder.rest_quant.setText(PROD_VAT.get(position));
        ...
        holder.quantity.setOnTouchListener(new OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                GiftOrder2.searchview.setFocusable(false);
                ...
                try {
                    ...
                    if (str.toString().isEmpty()) {
                        ...
                        for (Iterator i = keys.iterator(); i.hasNext();) {
                            ...
                            String product_rate = GiftOrder2.categoriesList.get(key).getPROD_RATE();
                            String ppm_code = GiftOrder2.categoriesList.get(key).getPPM_CODE();

                            String p_code = GiftOrder2.categoriesList.get(key).getP_CODE();
                        ...
                        GiftOrder2.totalsellquantity.setText("" + tota);
                        ...
                        if (checkZero > 0) {
                            ...
                            for (Iterator i = keys.iterator(); i.hasNext();) {
                                ...
                                String product_rate = GiftOrder2.categoriesList.get(8).getPROD_RATE();
        ...
        holder.quantity.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                ...
                //return false;
					/*	if (focusvalue==0) {
							GiftOrder.searchview.requestFocus();
							holder.quantity.clearFocus();

						}else {
							holder.quantity.requestFocus();
							GiftOrder.searchview.clearFocus();;
                ...
                if (!hasFocus) {
                    ...
                    focusvalue=1;
                    Log.i("focusvalue", ""+focusvalue);
                    //GiftOrderGiftOrder.searchview.setFocusableInTouchMode(false);
                    ...
                    try {
                        ...
                        // TODO: handle exception
                        GiftOrder2.searchview.setFocusable(true);
                    }
