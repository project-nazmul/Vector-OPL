...
public class AmTargetvalue extends Activity implements OnClickListener {
    ...
    private final String URL_PRODUCT_VIEW = BASE_URL+"area_manager_api/sales_reports/Targetvaluegrowth.php";
    ...
    private void initCalender() {
        ...
        fromdate.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new DatePickerDialog(AmTargetvalue.this, date_form, myCalendar.get(Calendar.YEAR), myCalendar.get(Calendar.MONTH),
        ...
        todate.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new DatePickerDialog(AmTargetvalue.this, date_to, myCalendar
                ...
                Thread backthred = new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            Intent i = new Intent(AmTargetvalue.this, AmSalesReportDashboard.class);
    ...
    class Spinner {
        ...
        private void populateSpinner() {
            ...
            RmTargetvalueProductShowAdapter adapter = new RmTargetvalueProductShowAdapter(AmTargetvalue.this, lables,
    ...
    private class GetCategories extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(AmTargetvalue.this);
        ...
        protected void onPostExecute(Void result) {
            ...
            if (pDialog.isShowing())
                pDialog.dismiss();
            AmTargetvalue.Spinner sp = new AmTargetvalue.Spinner();
            sp.populateSpinner();
            popSpinner();
    ...
    private void view() {
        Intent i = new Intent(AmTargetvalue.this, com.opl.pharmavector.AmSalesReportDashboard.class);
        startActivity(i);
        finish();
