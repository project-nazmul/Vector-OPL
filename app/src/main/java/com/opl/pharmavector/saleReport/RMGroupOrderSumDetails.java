...
//        fromDateOrd.setText(currentFromDate);
    ...
    private void calenderClickEvents() {
        ...
        fromDateOrd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new DatePickerDialog(RMGroupOrderSumDetails.this, dateFormOrd, fromCalendar.get(Calendar.YEAR), fromCalendar.get(Calendar.MONTH),
        ...
        toDateOrder.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new DatePickerDialog(RMGroupOrderSumDetails.this, dateToOrder, fromCalendar
    ...
    private void getGroupOrdSummaryDetails() {
        ...
        ProgressDialog pDialog = new ProgressDialog(RMGroupOrderSumDetails.this);
            ...
            public void onResponse(Call<GroupOrdSumDetailModel> call, Response<GroupOrdSumDetailModel> response) {
                if (response.isSuccessful()) {
                    ...
                    if (response.body() != null) {
                        ...
                        grpOrdSumDetailAdapter = new GrpOrdSumDetailAdapter(RMGroupOrderSumDetails.this, orderSumDetailLists, RMGroupOrderSumDetails.this);
                        LinearLayoutManager linearManager = new LinearLayoutManager(RMGroupOrderSumDetails.this);
                        recyclerOrderSumNew.setLayoutManager(linearManager);
                        recyclerOrderSumNew.setAdapter(grpOrdSumDetailAdapter);
                        recyclerOrderSumNew.addItemDecoration(new DividerItemDecoration(RMGroupOrderSumDetails.this, DividerItemDecoration.VERTICAL));
                    }
    ...
    public void onClick(int position, GroupOrderSumDetailList orderModel) {
        if (orderModel.getFfCode() != null) {
            Intent i = new Intent(RMGroupOrderSumDetails.this, AMGroupOrdSumDetails.class);
