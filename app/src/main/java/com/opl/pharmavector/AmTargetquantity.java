...
public class AmTargetquantity extends Activity implements OnClickListener {
    ...
    private final String URL_PRODUCT_VIEW = BASE_URL+"area_manager_api/sales_reports/Targetquantitygrowth.php";
                ...
                Thread backthred = new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            Intent i = new Intent(AmTargetquantity.this, AmSalesReportDashboard.class);
    ...
    private void initCalender() {
        ...
        fromdate.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new DatePickerDialog(AmTargetquantity.this, date_form, myCalendar.get(Calendar.YEAR), myCalendar.get(Calendar.MONTH),
        ...
        todate.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new DatePickerDialog(AmTargetquantity.this, date_to, myCalendar
    ...
    class Spinner {
        ...
        private void populateSpinner() {
            ...
            float prod_rate, prod_vat, sellvalue, ppm_code;
            for (int i = 0; i < categoriesList.size(); i++) {
            ...
            RmTargetquantityProductShowAdapter adapter = new RmTargetquantityProductShowAdapter(AmTargetquantity.this, lables, quanty, value, achv, growth);
    ...
    private class GetCategories extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(AmTargetquantity.this);
        ...
        protected void onPostExecute(Void result) {
            ...
            if (pDialog.isShowing())
                pDialog.dismiss();
            AmTargetquantity.Spinner sp = new AmTargetquantity.Spinner();
            sp.populateSpinner();
            popSpinner();
            totqty.setText("");
            totval.setText("");
    ...
    private void view() {
        Intent i = new Intent(AmTargetquantity.this, com.opl.pharmavector.Report.class);
        startActivity(i);
        finish();
