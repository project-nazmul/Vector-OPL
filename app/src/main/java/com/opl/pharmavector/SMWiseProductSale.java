...
public class SMWiseProductSale extends Activity implements OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    private String URL_PRODUCT_VIEW = BASE_URL+"productwisesales/SMWiseProductSale.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fromdate.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                new DatePickerDialog(SMWiseProductSale.this, date_form, myCalendar.get(Calendar.YEAR), myCalendar.get(Calendar.MONTH),
        ...
        todate.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                new DatePickerDialog(SMWiseProductSale.this, date_to, myCalendar
    ...
    class LoadProduct extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(SMWiseProductSale.this);
    ...
    private class GetCategories extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            if (json != null) {
                ...
                Toast.makeText(SMWiseProductSale.this, "Nothing To Disply", Toast.LENGTH_SHORT).show();
            }
            return null;
        }
        ...
        protected void onPostExecute(Void result) {
            ...
            if (pDialog.isShowing())
                pDialog.dismiss();
            SMWiseProductSale.Spinner sp = new SMWiseProductSale.Spinner();
            sp.populateSpinner();
            popSpinner();
            totqty.setText("");
            totval.setText("");
    ...
    private void view() {
        Intent i = new Intent(SMWiseProductSale.this, com.opl.pharmavector.Report.class);
        startActivity(i);
        finish();
    }
}
