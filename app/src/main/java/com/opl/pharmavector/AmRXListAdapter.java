...
public class AmRXListAdapter extends BaseAdapter implements Filterable {
    ...
    public AmRXListAdapter(Activity activity,
    ...
    AmRXListAdapter(Context con, ArrayList<String> sl, ArrayList<String> p_name, HashMap<Integer, String> p_quanty) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (rowView == null) {
            convertView = inflater.inflate(R.layout.amcompany_product_list, null);
        ...
        int srl = AmRxCompany.nameSerialPair.get(holder.p_name.getText().toString());
        ...
        holder.quantity.setOnTouchListener(new OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                AmRxCompany.searchview.setFocusable(false);
                ...
                try {
                    ...
                    if (str.toString().isEmpty()) {
                        ...
                        for (Iterator i = keys.iterator(); i.hasNext();) {
                            ...
                            String product_rate =  AmRxCompany.categoriesList.get(key).getPROD_RATE();
                            String ppm_code =  AmRxCompany.categoriesList.get(key).getPPM_CODE();

                            String p_code =  AmRxCompany.categoriesList.get(key).getP_CODE();
                        ...
                        AmRxCompany.totalsellquantity.setText("" + tota);
                        ...
                        if (checkZero > 0) {
                            ...
                            for (Iterator i = keys.iterator(); i.hasNext();) {
                                ...
                                String product_rate =  AmRxCompany.categoriesList.get(8).getPROD_RATE();
        ...
        holder.quantity.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                ...
                // RxCompany.searchview.setFocusable(false);
                //holder.quantity.setFocusable(true);
                //return false;
					/*	if (focusvalue==0) {
							 RxCompany.searchview.requestFocus();
							holder.quantity.clearFocus();

						}else {
							holder.quantity.requestFocus();
							 RxCompany.searchview.clearFocus();;
                ...
                if (!hasFocus) {
                    ...
                    // RxCompany.searchview.setFocusable(true);
                    //	holder.quantity.clearFocus();
                    //	 RxCompany.searchview.requestFocus();
                    focusvalue=0;
                    ...
                    focusvalue=1;
                    Log.i("focusvalue", ""+focusvalue);
                    //GiftOrder RxCompany.searchview.setFocusableInTouchMode(false);
                    ...
                    try {
                        ...
                        // TODO: handle exception
                        AmRxCompany.searchview.setFocusable(true);
                    }
