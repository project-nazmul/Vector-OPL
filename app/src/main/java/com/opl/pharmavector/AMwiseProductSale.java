...
public class AMwiseProductSale extends Activity implements OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    int textlength = 0;
    public TextView totqty, totval,fm;
    ...
    private final String URL_PRODUCT_VIEW = BASE_URL+"AMwiseProductSale1.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fm = (TextView) findViewById(R.id.mpo_code);
        fm.setText("Area\nCode");
        ...
        Toast.makeText(AMwiseProductSale.this, userName, Toast.LENGTH_LONG).show();
        ...
        fromdate.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new DatePickerDialog(AMwiseProductSale.this, date_form, myCalendar.get(Calendar.YEAR), myCalendar.get(Calendar.MONTH),
        ...
        todate.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new DatePickerDialog(AMwiseProductSale.this, date_to, myCalendar
                ...
                Thread backthred = new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            Intent i = new Intent(AMwiseProductSale.this,RmSalesReportDashboard.class);
    ...
    class LoadProduct extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(  AMwiseProductSale.this);
    ...
    class Spinner {
        ...
        private void populateSpinner() {
            ...
            MPOwiseProductSaleShowAdapter adapter = new MPOwiseProductSaleShowAdapter(AMwiseProductSale.this,lables, quanty,value,achv,mpo_code);
    ...
    private class GetCategories extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            if (json != null) {
                ...
                Log.e("JSON Data", "Didn't receive any data from server!");
                Toast.makeText(AMwiseProductSale.this, "Nothing To Disply",Toast.LENGTH_SHORT).show();
                Toast.makeText(AMwiseProductSale.this, "Please make a order first !",Toast.LENGTH_LONG).show();
            }
            return null;
        }
        @Override
        protected void onPostExecute(Void result) {
            ...
            if (pDialog.isShowing())
                pDialog.dismiss();
            AMwiseProductSale.Spinner sp = new AMwiseProductSale.Spinner();
            sp.populateSpinner();
            popSpinner();
            totqty.setText("");
            totval.setText("");
    ...
    private void view() {
        Intent i = new Intent(AMwiseProductSale.this, com.opl.pharmavector.Report.class);
        startActivity(i);
        finish();
