...
public class MPODcfpFollowupActivity extends Activity implements DcfpFollowupAdapter.DcfpClickListener {
    ...
    private void calenderInit() {
        ...
        tvfromdate.setOnClickListener(v -> new DatePickerDialog(MPODcfpFollowupActivity.this, date_form, myCalendar.get(Calendar.YEAR), myCalendar.get(Calendar.MONTH),
        ...
        tvtodate.setOnClickListener(v -> new DatePickerDialog(MPODcfpFollowupActivity.this, date_to, myCalendar
                .get(Calendar.YEAR), myCalendar.get(Calendar.MONTH),
                myCalendar1.get(Calendar.DAY_OF_MONTH)).show());
    }

    public void dcrDcfpFollowupInfo() {
        ProgressDialog dcfpFollowDialog = new ProgressDialog(MPODcfpFollowupActivity.this);
        ...
        call.enqueue(new Callback<List<DcrFollowupModel>>() {
            ...
            public void onResponse(@NonNull Call<List<DcrFollowupModel>> call, @NonNull retrofit2.Response<List<DcrFollowupModel>> response) {
                ...
                if (dcfpFollowupList.size() > 0) {
                    ...
                    dcfpFollowupRecycler.addItemDecoration(new DividerItemDecoration(MPODcfpFollowupActivity.this, DividerItemDecoration.VERTICAL));
                } else {
                    dcfpFollowDialog.dismiss();
                    Toast.makeText(MPODcfpFollowupActivity.this, "No data Available!", Toast.LENGTH_LONG).show();
                }
            }
