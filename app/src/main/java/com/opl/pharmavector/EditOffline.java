...
public class EditOffline extends Activity implements AdapterView.OnItemSelectedListener {
    ...
    private String URL_CUSOTMER = "http://opsonin.com.bd/vector_opl_v1/get_ordno.php";
            ...
            public void onClick(final View v) {
                ...
                if ((ded.getText().toString().trim().equals(""))
                    ...
                    Thread next = new Thread(new Runnable() {
                        @Override
                        public void run() {
                            Intent in = new Intent(EditOffline.this, EditOrdProdView.class);
    ...
    class GetCategories extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(EditOffline.this);
