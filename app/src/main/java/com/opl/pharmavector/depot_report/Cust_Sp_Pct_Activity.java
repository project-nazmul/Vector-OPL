...
public class Cust_Sp_Pct_Activity extends Activity {
    ...
    final String URL_PRODUCT_VIEW = BASE_URL+"mposalesreports/depo_report/sp_pct_cust_info.php";
    final String URL_CUSOTMER = BASE_URL+"mposalesreports/depo_report/sp_pct_cust_list.php";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.depot_cust_sp_pct);
        initViews();
        initCalender();
    ...
    private void initCalender() {
        ...
        fromdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new DatePickerDialog(Cust_Sp_Pct_Activity.this, date_form, myCalendar.get(Calendar.YEAR), myCalendar.get(Calendar.MONTH),
        ...
        todate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new DatePickerDialog(Cust_Sp_Pct_Activity.this, date_to, myCalendar
    ...
    private class GetCustomer extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Cust_Sp_Pct_Activity.this);
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            if (json != null) {
                ...
                Toast.makeText(Cust_Sp_Pct_Activity.this, "Nothing To Display", Toast.LENGTH_SHORT).show();
            }
            return null;
        }
        @Override
    ...
    private void dataload() {
        ...
        Call<ArrayList<RecyclerData>> call = apiInterface.getCust_Sp_Pct(userName, p_cust_code);
            ...
            public void onResponse(Call<ArrayList<RecyclerData>> call, Response<ArrayList<RecyclerData>> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    for (int i = 0; i < recyclerDataArrayList.size(); i++) {
                        recyclerViewAdapter = new RecycleViewAdapter(Cust_Sp_Pct_Activity.this,recyclerDataArrayList,"sp_pct");

                        LinearLayoutManager manager = new LinearLayoutManager(Cust_Sp_Pct_Activity.this, LinearLayoutManager.VERTICAL, true);
