...
public class MPODccStock extends Activity implements OnClickListener {
    ...
    private final String URL_PRODUCT_VIEW = BASE_URL + "MPODccStock.php";


    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.mpodccstock);
        ...
        submitBtn_2.setTextColor(Color.BLACK);
        ...
        productListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                ...
                String split_flag = arr1[1].trim();
                String arr2 = arr1[0].trim();
                String arr3[] = arr2.split("//");
                String brand_code_1 = arr3[0].trim();
                String rest_quant = arr3[1].trim();
                String arr4[] = brand_code_1.split("#");
                String brand_code = arr4[0].trim();
                String p_code = arr4[1].trim();
                if (split_flag.equals("N")) {
                    Toast.makeText(MPODccStock.this, "You are not allowed to split DCC of this brand", Toast.LENGTH_LONG).show();
                } else if (rest_quant.equals("0")) {
                    Toast.makeText(MPODccStock.this, "Remaining quantity of DCC is 0", Toast.LENGTH_LONG).show();
                } else {
                    Intent i = new Intent(MPODccStock.this, MPODCCSplit.class);
                    i.putExtra("brand_code", brand_code);
                    i.putExtra("UserName", userName);
                    i.putExtra("rest_quant", rest_quant);
                    i.putExtra("UserName", userName);
        ...
        fromdate.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new DatePickerDialog(MPODccStock.this, date_form, myCalendar.get(Calendar.YEAR), myCalendar.get(Calendar.MONTH),
        ...
        todate.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new DatePickerDialog(MPODccStock.this, date_to, myCalendar
    ...
    class Spinner {
        ...
        private void populateSpinner() {
            ...
            MPODccStockAdapter adapter = new MPODccStockAdapter(MPODccStock.this, sl, lables, quanty, value, value4, value5, value6, value7, value8);
    ...
    private class GetCategories extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(MPODccStock.this);
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            if (json != null) {
                ...
                Toast.makeText(MPODccStock.this, "Nothing To Disply", Toast.LENGTH_SHORT).show();
                Toast.makeText(MPODccStock.this, "Please make a order first !", Toast.LENGTH_LONG).show();
            }
            return null;
        }
        ...
        protected void onPostExecute(Void result) {
            ...
            if (pDialog.isShowing())
                pDialog.dismiss();
            MPODccStock.Spinner sp = new MPODccStock.Spinner();
            sp.populateSpinner();
            popSpinner();
    ...
    private void view() {
        Intent i = new Intent(MPODccStock.this, Report.class);
        startActivity(i);
        finish();
