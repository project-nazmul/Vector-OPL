...
public class AmTargetquantityProductShowAdapter extends BaseAdapter {
    TextView serial;
    CheckBox check;
    Context mContext;
    ...
    AmTargetquantityProductShowAdapter(Context con, ArrayList<String> product_name,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        rowView = inflater.inflate(R.layout.amviewbytargetquantity_show, parent, false);
        ...
        holder.segment = (TextView) rowView.findViewById(R.id.segment_code);
        ...
        holder.segment.setText(segment_code.get(position));
