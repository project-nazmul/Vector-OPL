...
public class SMGroupOrderSumDetails extends Activity implements GrpOrdSumDetailAdapter.ItemClickListener {
...
//        fromDateOrd.setText(currentFromDate);
    ...
    private void calenderClickEvents() {
        ...
        fromDateOrd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new DatePickerDialog(SMGroupOrderSumDetails.this, dateFormOrd, fromCalendar.get(Calendar.YEAR), fromCalendar.get(Calendar.MONTH),
        ...
        toDateOrder.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new DatePickerDialog(SMGroupOrderSumDetails.this, dateToOrder, fromCalendar
    ...
    private void getGroupOrdSummaryDetails() {
        ...
        ProgressDialog pDialog = new ProgressDialog(SMGroupOrderSumDetails.this);
            ...
            public void onResponse(Call<GroupOrdSumDetailModel> call, Response<GroupOrdSumDetailModel> response) {
                if (response.isSuccessful()) {
                    ...
                    if (response.body() != null) {
                        ...
                        grpOrdSumDetailAdapter = new GrpOrdSumDetailAdapter(SMGroupOrderSumDetails.this, orderSumDetailLists, SMGroupOrderSumDetails.this);
                        LinearLayoutManager linearManager = new LinearLayoutManager(SMGroupOrderSumDetails.this);
                        recyclerOrderSumNew.setLayoutManager(linearManager);
                        recyclerOrderSumNew.setAdapter(grpOrdSumDetailAdapter);
                        recyclerOrderSumNew.addItemDecoration(new DividerItemDecoration(SMGroupOrderSumDetails.this, DividerItemDecoration.VERTICAL));
                    }
    ...
    public void onClick(int position, GroupOrderSumDetailList orderModel) {
        if (orderModel.getFfCode() != null) {
            Intent i = new Intent(SMGroupOrderSumDetails.this, ASMGroupOrdSumDetails.class);
