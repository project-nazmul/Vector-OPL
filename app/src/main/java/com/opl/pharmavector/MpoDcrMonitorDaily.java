...
public class MpoDcrMonitorDaily extends Activity implements OnClickListener {
    ...
    private final String URL_PRODUCT_VIEW =BASE_URL+"regional_manager_api/dcrmonitor/MpoDcrMonitorDaily.php";
    private final String COUNT_MPO_DCR =BASE_URL+"regional_manager_api/dcrmonitor/COUNT_FM_DCR.php";
    private final String COUNT_MPO =BASE_URL+"regional_manager_api/dcrmonitor/COUNT_FM.php";
    private final String REQ_MPO =BASE_URL+"regional_manager_api/dcrmonitor/REQ_FM.php";
    private final String Submit_DCR_MPO =BASE_URL+"regional_manager_api/dcrmonitor/Submit_DCR_FM.php";
    private final String Not_Submit_DCR_MPO =BASE_URL+"regional_manager_api/dcrmonitor/Not_Submit_DCR_FM.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mpodcrmonitordaily);
        ...
        fromdate.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new DatePickerDialog(MpoDcrMonitorDaily.this, date_form, myCalendar.get(Calendar.YEAR), myCalendar.get(Calendar.MONTH),
        ...
        productListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                String test = (String) productListView.getAdapter().getItem(arg2);
            }
        });
        ...
        todate.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new DatePickerDialog(MpoDcrMonitorDaily.this, date_to, myCalendar
            ...
            public void onClick(final View v) {
                ...
                Thread backthred = new Thread(new Runnable() {
                    ...
                    public void run() {
                        // TODO Auto-generated method stub
                        try {
                            Intent i = new Intent(MpoDcrMonitorDaily.this,  RmDashboard.class);
        ...
        btn_2.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(final View v) {
                try {
                    ...
                    //  Toast.makeText(getApplicationContext(), "123456" +"submitted by mpo button is clicked" , Toast.LENGTH_LONG).show();
    ...
    class Spinner {
        ...
        private void populateSpinner() {
            ...
            MpoDailyMonitorShowAdapter adapter = new MpoDailyMonitorShowAdapter(MpoDcrMonitorDaily.this,sl,lables, quanty, value,value4,value5,value6,value7);
                ...
                try {
                    ...
                    if (jsonObj != null) {
                        ...
                        for (int i = 0; i <= customer.length(); i++) {
                            ...
                            com.opl.pharmavector.Customer custo = new com.opl.pharmavector.Customer(catObj.getInt("id"),catObj.getString("name"));
    ...
    private class Not_Submit_DCR_MPO extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(MpoDcrMonitorDaily.this);
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            if (json != null) {
                ...
                Log.e("JSON Data", "Didn't receive any data from server!");
                Toast.makeText(MpoDcrMonitorDaily.this, "Nothing To Disply",Toast.LENGTH_SHORT).show();
                Toast.makeText(MpoDcrMonitorDaily.this, "Please make a order first !",Toast.LENGTH_LONG).show();
            }
            return null;
        }
        @Override
        protected void onPostExecute(Void result) {
            ...
            if (pDialog.isShowing())
                pDialog.dismiss();
            MpoDcrMonitorDaily.Spinner sp = new MpoDcrMonitorDaily.Spinner();
            sp.populateSpinner();
            popSpinner();
...
*/
    ...
    private void view() {
        Intent i = new Intent(MpoDcrMonitorDaily.this, Report.class);
        startActivity(i);
        finish();
