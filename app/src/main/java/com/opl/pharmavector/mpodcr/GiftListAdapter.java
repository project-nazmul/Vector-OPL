...
public class GiftListAdapter extends BaseAdapter implements Filterable {
    ...
    public GiftListAdapter(Activity activity, ArrayList<HashMap<String, String>> list, String productname, boolean state) {
        super();
    ...
    public Object SHIFT_CODE(int position) { return SHIFT_CODE.get(position); }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (rowView == null) {
            ...
            holder.p_name =  convertView.findViewById(R.id.product_name);
            holder.ppm_error =  convertView.findViewById(R.id.ppm_error);
            holder.quantity =  convertView.findViewById(R.id.order_qnty);
            edit_qnty=  convertView.findViewById(R.id.order_qnty);
            holder.total_gift = convertView.findViewById(R.id.total_gift);
        ...
        int srl = GiftOrder.nameSerialPair.get(holder.p_name.getText().toString());
                ...
                try {
                    if (str.toString().isEmpty()) {
                        ...
                        for (Iterator i = keys.iterator(); i.hasNext();) {
                            ...
                            String product_rate = GiftOrder.categoriesList.get(key).getPROD_RATE();
                            String ppm_code = GiftOrder.categoriesList.get(key).getPPM_CODE();
                            String p_code = GiftOrder.categoriesList.get(key).getP_CODE();
