...
public class Category3 {
	...
	public Category3(String sl, String id, String name,String quantity,String PROD_RATE,String PROD_VAT){
		this.sl=sl;
		this.id = id;
		this.name = name;
	...
	public Category3(String sl, String id, String name,String quantity,String PROD_RATE,String PROD_VAT,String PROD_VAT_2){
		this.sl=sl;
		this.id = id;
		this.name = name;
		this.quantity = quantity;
	...
	public Category3(String sl, String id, String name,String quantity,String PROD_RATE,String PROD_VAT,String PROD_VAT_2,String PROD_VAT_3,String PROD_VAT_4){
		this.sl=sl;
		this.id = id;
		this.name = name;
		this.quantity = quantity;
	...
	public Category3(String sl, String id, String name,String quantity,String PROD_RATE,String PROD_VAT,String PROD_VAT_2,String PROD_VAT_3,String PROD_VAT_4,String PROD_VAT_5){
		this.sl=sl;
		this.id = id;
		this.name = name;
		this.quantity = quantity;
