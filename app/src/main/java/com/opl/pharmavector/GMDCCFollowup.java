...
public class GMDCCFollowup extends Activity implements OnClickListener {
    ...
    public String message, ord_no, asm_code, gm_code, gm_flag;
    ...
    private final String URL_DETAIL_VIEW = BASE_URL_AM + "assistant_manager_dcc_campaign/general_manager_dcc_master.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gm_code = b.getString("UserName");

        gm_flag = b.getString("gm_flag");

        //  Toast.makeText(GMDCCFollowup.this, "gmdccfollowup"+gm_flag+"-----"+gm_code, Toast.LENGTH_LONG).show();
        ...
        productListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                ...
                Intent i = new Intent(GMDCCFollowup.this, SalesManagerDCCFollowup.class);
                ...
                Log.w("GOTO-SManagDCCFollowup", gm_code + "- RM CODE --" + gm_flag + "--gm_code--" + gm_flag);
                startActivity(i);
                ...
                Thread backthred = new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            Intent i = new Intent(GMDCCFollowup.this, GMDashboard1.class);
                            i.putExtra("UserName", userName);
        ...
        detail.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                pDialog = new ProgressDialog(GMDCCFollowup.this);
                ...
                Thread backthred = new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            Intent i = new Intent(GMDCCFollowup.this, AssistantManagerDCCFollowup.class);
                            i.putExtra("UserName", userName);
                            i.putExtra("new_version", userName);
                            i.putExtra("UserName_1", UserName_1);
                            i.putExtra("UserName_2", UserName_2);
    ...
    class Spinner {
        ...
        private void populateSpinner() {
            ...
            DccCampAdapter adapter = new DccCampAdapter(GMDCCFollowup.this, sl, lables, quanty, value, value4, value5, value6, value7, value8, value9, value10, value11, value12);
    ...
    class Spinner2 {
        ...
        private void populateSpinner2() {
            ...
            DccCampAdapter adapter2 = new DccCampAdapter(GMDCCFollowup.this, sl, lables, quanty, value, value4, value5, value6, value7, value8, value9, value10, value11, value12);
    ...
    private class January extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(GMDCCFollowup.this);
            pDialog.setTitle("Sales Manager Data Loading !");
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            if (json != null) {
                ...
                Toast.makeText(GMDCCFollowup.this, "Nothing To Disply", Toast.LENGTH_SHORT).show();
                Toast.makeText(GMDCCFollowup.this, "Please make a order first !", Toast.LENGTH_LONG).show();
            }
            return null;
        }
    ...
    private void view() {
        Intent i = new Intent(GMDCCFollowup.this, Report.class);
        startActivity(i);
        finish();
