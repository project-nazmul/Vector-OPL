...
//        });
        ...
        s_time.setOnClickListener(v -> {
            ...
            mTimePicker = new TimePickerDialog(DcrEntryActivity.this, (timePicker, selectedHour, selectedMinute) -> s_time.setText(selectedHour + ":" + selectedMinute), hour, minute, true); //Yes 24 hour time
...
//            int shift_check = Integer.parseInt(day_shift);
        ...
        shift_spinner.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onNothingSelected(AdapterView<?> adapterView) {
                Toast.makeText(DcrEntryActivity.this, "Please Select Shift !!", Toast.LENGTH_LONG).show();
            }
        });
...
//            }
            ...
            Thread next = new Thread(new Runnable() {
                @Override
                public void run() {
                    Intent in = new Intent(DcrEntryActivity.this, ChemistGiftOrder.class);
            ...
            if ((ded.getText().toString().trim().equals("")) || (ded.getText().toString().trim().equals("Reference Date")) || (ded.getText().toString().trim().equals("Please Select date"))) {
                ...
                Thread server = new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Intent sameint = new Intent(DcrEntryActivity.this, DcrEntryActivity.class);
        ...
        call.enqueue(new Callback<List<Patient>>() {
            ...
            public void onResponse(@NonNull Call<List<Patient>> call, @NonNull Response<List<Patient>> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    Toast.makeText(DcrEntryActivity.this, "Server error! Please try moments later", Toast.LENGTH_SHORT).show();
                }
            }
...
//        date_str = df.format(cal.getTime());
        ...
        ded.setOnClickListener(v -> {
            if (dcfpStatusFlag == 1) {
                ...
                new DatePickerDialog(DcrEntryActivity.this, date, myCalendar.get(Calendar.YEAR), myCalendar.get(Calendar.MONTH), myCalendar.get(Calendar.DAY_OF_MONTH)).show();
            }
            //location.setVisibility(View.VISIBLE);
        });
    }
            ...
            public void afterTextChanged(final Editable s) {
                try {
                    ...
                    if (inputorder.contains("-")) {
                        ...
                        hideKeyboard(DcrEntryActivity.this);
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
            ...
            public void afterTextChanged(final Editable s) {
                try {
                    ...
                    if (inputorder.contains(":")) {
                        ...
                        ArrayAdapter dataAdapter = new ArrayAdapter(DcrEntryActivity.this, android.R.layout.simple_spinner_item, list);
                        ...
                        ArrayAdapter dataAdapter_credit = new ArrayAdapter(DcrEntryActivity.this, android.R.layout.simple_spinner_item, list);
...
//        location.setVisibility(View.VISIBLE);
    ...
    class GetCategories extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(DcrEntryActivity.this);
...
//            params.add(new BasicNameValuePair("shift", shift_spinner.getSelectedItem().toString()));
    ...
    class GetEmp extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog2 = new ProgressDialog(DcrEntryActivity.this);
