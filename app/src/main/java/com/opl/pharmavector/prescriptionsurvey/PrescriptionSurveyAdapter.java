...
public class PrescriptionSurveyAdapter  extends BaseAdapter {
    ...
    PrescriptionSurveyAdapter (Context con, ArrayList<String> product_name, ArrayList<String> qnty_3, ArrayList<String> value_3) {
    ...
    PrescriptionSurveyAdapter (Context con, ArrayList<String> product_name, ArrayList<String> qnty_3, ArrayList<String> value_3,ArrayList<String> value_4) {
        this.product_name = product_name;
        this.qnty = qnty_3;
        this.value = value_3;
        this.value4 = value_4;
    ...
    PrescriptionSurveyAdapter (Context con, ArrayList<String> product_name, ArrayList<String> qnty_3, ArrayList<String> value_3,ArrayList<String> value_4,ArrayList<String> value_5) {
        this.product_name = product_name;
        this.qnty = qnty_3;
        this.value = value_3;
        this.value4 = value_4;
    ...
    PrescriptionSurveyAdapter (Context con,ArrayList<String> sl, ArrayList<String> product_name, ArrayList<String> qnty_3, ArrayList<String> value_3,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //  rowView = inflater.inflate(R.layout.amdccfollowupadapter, parent, false);
