...
public class RMDcrreportvalueProductShowAdapter extends BaseAdapter {
...
*/
    ...
    RMDcrreportvalueProductShowAdapter(Context con, ArrayList<String> product_name, ArrayList<String> qnty_3, ArrayList<String> value_3) {
        this.product_name = product_name;
        this.qnty = qnty_3;
        this.value = value_3;
        this.mContext = con;
    ...
    RMDcrreportvalueProductShowAdapter(Context con, ArrayList<String> product_name, ArrayList<String> qnty_3, ArrayList<String> value_3,ArrayList<String> value_4) {
        this.product_name = product_name;
        this.qnty = qnty_3;
        this.value = value_3;
        this.value4 = value_4;
    ...
    RMDcrreportvalueProductShowAdapter(Context con, ArrayList<String> product_name, ArrayList<String> qnty_3, ArrayList<String> value_3,ArrayList<String> value_4,ArrayList<String> value_5) {
        this.product_name = product_name;
        this.qnty = qnty_3;
        this.value = value_3;
        this.value4 = value_4;
    ...
    RMDcrreportvalueProductShowAdapter(Context con,ArrayList<String> sl, ArrayList<String> product_name, ArrayList<String> qnty_3, ArrayList<String> value_3,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final RMDcrreportvalueProductShowAdapter.ViewHolder holder = new RMDcrreportvalueProductShowAdapter.ViewHolder();
        rowView = inflater.inflate(R.layout.rmviewbydatedcrreport, parent, false);

        serial = (TextView) rowView.findViewById(R.id.serial);
        holder.product_name = (TextView) rowView.findViewById(R.id.manager_dcr);
        holder.sl =     (TextView) rowView.findViewById(R.id.serial);
        holder.qnty =   (TextView) rowView.findViewById(R.id.manager_dcr_code);
        holder.value =  (TextView) rowView.findViewById(R.id.value_3);
        holder.value4 = (TextView) rowView.findViewById(R.id.dcr_market_name);
        holder.value5 = (TextView) rowView.findViewById(R.id.dcr_manager_sshift);
