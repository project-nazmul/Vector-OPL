...
public class AMwiseProductSale2 extends Activity implements OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                i.putExtra("UserName", query_code);
                i.putExtra("query_code", query_code);
               // Toast.makeText(AMwiseProductSale2.this, "AMwiseProductsale2-AMfollowMPOAchv2", Toast.LENGTH_LONG).show();
                startActivity(i);
    ...
    class Spinner {
        ...
        private void populateSpinner() {
            ...
            MPOwiseAchvfollowupAdapter adapter = new MPOwiseAchvfollowupAdapter(AMwiseProductSale2.this,lables,
    ...
    private class GetCategories extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            if (json != null) {
                ...
                Log.e("JSON Data", "Didn't receive any data from server!");
                Toast.makeText(AMwiseProductSale2.this, "Nothing To Disply", Toast.LENGTH_SHORT).show();
