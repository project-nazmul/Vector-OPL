...
public class MpoDailyMonitorShowAdapter extends BaseAdapter {
...
*/
    ...
    MpoDailyMonitorShowAdapter(Context con, ArrayList<String> product_name, ArrayList<String> qnty_3, ArrayList<String> value_doctor) {
        this.product_name = product_name;
        this.qnty = qnty_3;
    ...
    MpoDailyMonitorShowAdapter(Context con, ArrayList<String> product_name, ArrayList<String> qnty_3, ArrayList<String> value_doctor,ArrayList<String> value_4) {
        this.product_name = product_name;
        this.qnty = qnty_3;
        this.value = value_doctor;
        this.value4 = value_4;
    ...
    MpoDailyMonitorShowAdapter(Context con, ArrayList<String> product_name, ArrayList<String> qnty_3, ArrayList<String> value_doctor,ArrayList<String> value_4,ArrayList<String> value_5) {
        this.product_name = product_name;
        this.qnty = qnty_3;
        this.value = value_doctor;
        this.value4 = value_4;
    ...
    MpoDailyMonitorShowAdapter(Context con,ArrayList<String> sl, ArrayList<String> product_name, ArrayList<String> qnty_3, ArrayList<String> value_doctor,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        rowView = inflater.inflate(R.layout.mpodailymonitoradapter, parent, false);
