...
public class AMGroupOrdSumDetails extends Activity implements GrpOrdSumDetailAdapter.ItemClickListener {
...
//        fromDateOrd.setText(currentFromDate);
    ...
    private void calenderClickEvents() {
        ...
        fromDateOrd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new DatePickerDialog(AMGroupOrdSumDetails.this, dateFormOrd, fromCalendar.get(Calendar.YEAR), fromCalendar.get(Calendar.MONTH),
        ...
        toDateOrder.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new DatePickerDialog(AMGroupOrdSumDetails.this, dateToOrder, fromCalendar
    ...
    private void getGroupOrdSummaryDetails() {
        ...
        ProgressDialog pDialog = new ProgressDialog(AMGroupOrdSumDetails.this);
            ...
            public void onResponse(Call<GroupOrdSumDetailModel> call, Response<GroupOrdSumDetailModel> response) {
                if (response.isSuccessful()) {
                    ...
                    if (response.body() != null) {
                        ...
                        grpOrdSumDetailAdapter = new GrpOrdSumDetailAdapter(AMGroupOrdSumDetails.this, orderSumDetailLists, AMGroupOrdSumDetails.this);
                        LinearLayoutManager linearManager = new LinearLayoutManager(AMGroupOrdSumDetails.this);
                        recyclerOrderSumNew.setLayoutManager(linearManager);
                        recyclerOrderSumNew.setAdapter(grpOrdSumDetailAdapter);
                        recyclerOrderSumNew.addItemDecoration(new DividerItemDecoration(AMGroupOrdSumDetails.this, DividerItemDecoration.VERTICAL));
                    }
    ...
    public void onClick(int position, GroupOrderSumDetailList orderModel) {
        if (orderModel.getFfCode() != null) {
            Intent i = new Intent(AMGroupOrdSumDetails.this, MPOGroupOrdSumDetails.class);
