...
public class DcrReportScreen extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dcrreportdashboard);
        ...
        Log.w("receive ReportDashboard", userName + "---" + UserName_2+"----"+ new_version);
        ...
        try {
            // URL css = new URL("http://192.168.10.54/products/style.css");
...
//           NativeCSS.styleWithCSS("style.css", css, Never);
                    ...
                    public void run() {
                        ...
                        try {
                            if (!NetInfo.isOnline(getBaseContext())) {
                                ...
                                Intent i = new Intent(DcrReportScreen.this, DcrReport.class);
                    ...
                    public void run() {
                        ...
                        try {
                            if (!NetInfo.isOnline(getBaseContext())) {
                                ...
                                ArrayList<String> UserName_2 = db.getterritoryname();
                                String user = UserName_2.toString();
                                Intent i = new Intent(DcrReportScreen.this, MPODccStock.class);
                    ...
                    public void run() {
                        ...
                        try {
                            if (!NetInfo.isOnline(getBaseContext())) {
                                ...
                                ArrayList<String> UserName_2 = db.getterritoryname();
                                String user = UserName_2.toString();
                                Intent i = new Intent(DcrReportScreen.this, DcrReportScreen.class);
                                ...
                                Intent i = new Intent(DcrReportScreen.this, MPODccFollowup.class);
                                // Intent i = new Intent(Dashboard.this, DcrReport.class);
                ...
                Thread backthred = new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            Intent i = new Intent(DcrReportScreen.this, Dashboard.class);
                            i.putExtra("UserName", userName);
    ...
    private void logoutUser() {
        ...
        session.invalidate();
        Intent intent = new Intent(DcrReportScreen.this, Login.class);
