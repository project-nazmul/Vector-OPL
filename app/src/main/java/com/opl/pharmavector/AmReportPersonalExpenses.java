...
public class AmReportPersonalExpenses extends Activity implements OnClickListener {
    ...
    private final String URL_PRODUCT_VIEW =BASE_URL+"area_manager_api/personal_expense/ReportPersonalExpenses.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submitBtn_2.setTextColor(Color.WHITE);
        ...
        fromdate.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new DatePickerDialog(AmReportPersonalExpenses.this, date_form, myCalendar.get(Calendar.YEAR), myCalendar.get(Calendar.MONTH),
        ...
        todate.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new DatePickerDialog(AmReportPersonalExpenses.this, date_to, myCalendar
	...
	*/
    ...
    class Spinner {
        ...
        private void populateSpinner() {
            ...
            PexpReportShowAdapter adapter = new PexpReportShowAdapter(AmReportPersonalExpenses.this,sl,lables, quanty, value,value4,value5,value6,value7);

            //  DcrreportvalueProductShowAdapter adapter = new DcrreportvalueProductShowAdapter(ReportPersonalExpenses.this,sl,lables, quanty, value,value4,value5,value6,value7);
    ...
    private class GetCategories extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(AmReportPersonalExpenses.this);
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            if (json != null) {
                ...
                Toast.makeText(AmReportPersonalExpenses.this, "Nothing To Disply",Toast.LENGTH_SHORT).show();
                Toast.makeText(AmReportPersonalExpenses.this, "Please make a order first !",Toast.LENGTH_LONG).show();
            }
            return null;
        }
        @Override
...
*/
    ...
    private void view() {
        Intent i = new Intent(AmReportPersonalExpenses.this, AmReport.class);
        startActivity(i);
        finish();
