...
public class MonthYearPickerDialog2 extends DialogFragment {
        ...
        builder.setView(dialog)
                ...
                .setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                       ...
                       // Log.e("yearPicker", String.valueOf(yearPicker.getValue()));
                        monthPicker_val=String.valueOf(monthPicker.getValue());
                        yearPicker_val=String.valueOf(yearPicker.getValue());

                        // Log.e("monthPicker", String.valueOf(monthPicker.getValue()));

                    }
                })
                .setNegativeButton(R.string.cancel, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        MonthYearPickerDialog2.this.getDialog().cancel();
                    }
                });
