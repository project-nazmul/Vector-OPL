...
/**
 * Created by onik on 4/16/2018.
 EditOfflineProdListAdapter
 */
...
public class EditOfflineProdListAdapter extends BaseAdapter implements Filterable {
    ...
    public  EditOfflineProdListAdapter(Activity activity,
    ...
    EditOfflineProdListAdapter(Context con, ArrayList<String> sl, ArrayList<String> p_name, HashMap<Integer, String> p_quanty) {

        this.p_names = p_name;
        this.mStringList = p_name;
        EditOfflineProdListAdapter.p_quanty = p_quanty;
        this.sl = sl;
        this.mContext = con;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        int srl = EditOrdProdView.nameSerialPair.get(holder.p_name.getText().toString());
                ...
                try {
                    ...
                    if (str.toString().isEmpty()) {
                        ...
                        for (Iterator i = keys.iterator(); i.hasNext();) {
                            ...
                            String product_rate = EditOrdProdView.arrayList2.get(key).getproductrate();
                        ...
                        EditOrdProdView.totalsellquantity.setText("" + tota);
                        ...
                        if (checkZero > 0) {
                            ...
                            Log.i("EditOrdProdView","-------clicked to value chane----------");
                            ...
                            for (Iterator i = keys.iterator(); i.hasNext();) {
                                ...
                                String product_rate = EditOrdProdView.arrayList2.get(8).getproductrate();
