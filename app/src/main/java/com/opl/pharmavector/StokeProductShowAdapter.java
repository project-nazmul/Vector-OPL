...
public class StokeProductShowAdapter extends BaseAdapter {
	TextView serial;
	// TextView p_name;
	// EditText quanty;
	CheckBox check;
	...
	StokeProductShowAdapter(Context con, ArrayList<String> product_name,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		rowView = inflater.inflate(R.layout.stokeproduct_show, parent, false);
		serial = (TextView) rowView.findViewById(R.id.serial_stock);
		holder.product_name = (TextView) rowView.findViewById(R.id.product_name_stock);
		holder.qnty = (TextView) rowView.findViewById(R.id.qntystock);
