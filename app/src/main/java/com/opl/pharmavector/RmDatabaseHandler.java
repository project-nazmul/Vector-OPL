...
public class RmDatabaseHandler extends SQLiteOpenHelper {
    ...
    public void addProducts(com.opl.pharmavector.Product product) {
    ...
    public void addCustomers(com.opl.pharmavector.OfflineCustomer customer) {
        SQLiteDatabase db = this.getReadableDatabase();
    ...
    public void addDcrDate(com.opl.pharmavector.DcrDate dcrDate) {
        SQLiteDatabase db = this.getReadableDatabase();
    ...
    public void addDcrDateRange (com.opl.pharmavector.DcrDate dcrDate) {
        SQLiteDatabase db = this.getReadableDatabase();
    ...
    public void Ordmain(com.opl.pharmavector.Ordmain ordmain) {
    ...
    public void Orditem(com.opl.pharmavector.Orditem orditem) {
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    public void updateOrditem(com.opl.pharmavector.Orditem orditem) {
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    public ArrayList<com.opl.pharmavector.test> getProductdetails()
    {
        ArrayList<com.opl.pharmavector.test> array_list = new ArrayList<com.opl.pharmavector.test>();
        SQLiteDatabase db = this.getReadableDatabase();
        db.beginTransaction();
        try {
            ...
            while (cursor.moveToNext()) {
                ...
                array_list.add(new com.opl.pharmavector.test(product_sl,product_code,product_quant,product_name,product_rate,product_vat));
    ...
    public ArrayList<com.opl.pharmavector.test1> getsavedProductdetails(String ord_no)
    {
        ArrayList<com.opl.pharmavector.test1> array_list2 = new ArrayList<com.opl.pharmavector.test1>();
        SQLiteDatabase db = this.getReadableDatabase();
        db.beginTransaction();
        ...
        try {
            ...
            while (cursor.moveToNext()) {
                ...
                array_list2.add(new com.opl.pharmavector.test1(product_sl,product_code,product_quant,product_name,product_rate,product_vat));
