...
public class AmDoctorDcrReportValAdapter extends BaseAdapter {
...
*/
    ...
    AmDoctorDcrReportValAdapter(Context con, ArrayList<String> product_name, ArrayList<String> item_name, ArrayList<String> type) {
        this.product_name = product_name;
        this.qnty = item_name;
        this.value = type;
        this.mContext = con;
    ...
    AmDoctorDcrReportValAdapter(Context con, ArrayList<String> product_name, ArrayList<String> item_name, ArrayList<String> type,ArrayList<String> quant) {
        this.product_name = product_name;
        this.qnty = item_name;
        this.value = type;
        this.value4 = quant;
    ...
    AmDoctorDcrReportValAdapter(Context con, ArrayList<String> product_name, ArrayList<String> item_name, ArrayList<String> type,ArrayList<String> quant,ArrayList<String> value_5) {
        this.product_name = product_name;
        this.qnty = item_name;
        this.value = type;
        this.value4 = quant;
    ...
    AmDoctorDcrReportValAdapter(Context con,ArrayList<String> sl, ArrayList<String> product_name, ArrayList<String> item_name, ArrayList<String> type,
