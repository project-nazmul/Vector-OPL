 ...
 public class CategoryAdapter9 extends ArrayAdapter<Category> {
     private final List<Category> list;

     public CategoryAdapter9(Context context, int resource, List<Category> list) {
             ...
             viewHolder.categoryCheckBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                 ...
                 public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                     ...
                     if (buttonView.isChecked()) {
                         if (!FavouriteCategoriesJsonParser11.selectedCategories.contains(String.valueOf(list.get(getPosition).getCateogry_id()))) {
                             FavouriteCategoriesJsonParser11.selectedCategories.add(String.valueOf(list.get(getPosition).getCateogry_id()));
                             //FavouriteCategoriesJsonParser11.selectedphonenumber.add(String.valueOf(list.get(getPosition).getCategory_Name3()));
                             FavouriteCategoriesJsonParser11.selectedphonenumber.add(viewHolder.categoryName3.getText().toString());
                         ...
                         if (FavouriteCategoriesJsonParser11.selectedCategories.contains(String.valueOf(list.get(getPosition).getCateogry_id()))) {
                             FavouriteCategoriesJsonParser11.selectedCategories.remove(String.valueOf(list.get(getPosition).getCateogry_id()));
                             // FavouriteCategoriesJsonParser11.selectedphonenumber.remove(String.valueOf(list.get(getPosition).getCategory_Name3()));
                             FavouriteCategoriesJsonParser11.selectedphonenumber.remove(viewHolder.categoryName3.getText().toString());
