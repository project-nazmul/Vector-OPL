...
public class ChemistGiftListAdapter extends BaseAdapter implements Filterable {
    ...
    ArrayList<String> allocated;

    ArrayList<String> ppm_type;
    ArrayList<String> ppm_desc;
    ...
    public ChemistGiftListAdapter(Activity activity,
    ...
    ChemistGiftListAdapter(Context con, ArrayList<String> sl, ArrayList<String> p_name, HashMap<Integer, String> p_quanty) {
    ...
    ChemistGiftListAdapter(Context con, ArrayList<String> sl, ArrayList<String> p_name, HashMap<Integer, String> p_quanty,ArrayList<String> value7) {
    ...
    ChemistGiftListAdapter(Context con, ArrayList<String> sl, ArrayList<String> p_name, HashMap<Integer, String> p_quanty,ArrayList<String> value7,ArrayList<String> allocated) {
    ...
    ChemistGiftListAdapter(Context con, ArrayList<String> sl, ArrayList<String> p_name, HashMap<Integer, String> p_quanty,ArrayList<String> value7,
                           ArrayList<String> allocated, ArrayList<String> ppm_desc, ArrayList<String> ppm_type) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (rowView == null) {
            convertView = inflater.inflate(R.layout.chemist_product_list, null);
            ...
            holder.ppm_type = (TextView) convertView.findViewById(R.id.ppm_typ);
            holder.ppm_desc = (TextView) convertView.findViewById(R.id.ppm_desc);
        ...
        holder.remain.setText(value7.get(position));

        holder.alloc.setText(allocated.get(position));


        holder.ppm_type.setText(ppm_type.get(position));
        holder.ppm_desc.setText(ppm_desc.get(position));


        Log.w("allocated", allocated.get(position));
                ...
                try {
                    ...
                    if (str.toString().isEmpty()) {
                        ...
                        for (Iterator i = keys.iterator(); i.hasNext();) {
                            ...
                            String product_rate =  ChemistGiftOrder.categoriesList2.get(key).getPROD_RATE();
                            String ppm_code =  ChemistGiftOrder.categoriesList2.get(key).getPPM_CODE();

                            String p_code =  ChemistGiftOrder.categoriesList2.get(key).getP_CODE();
                        ...
                        if (checkZero > 0) {
                            ...
                            if(given_qnty> stock_qnty){
                                ...
                                holder.quantity.setText("0");
                                p_quanty.put(p_serial, "0");
                                holder.ppm_error.setText("*Alert*\n Remain \n" +stock_qnty);
                            }
...
/*
                            ...
                            for (Iterator i = keys.iterator(); i.hasNext();) {
                                Integer key = (Integer) i.next();
                                String value = (String) dataSet.get(i);
                                try {
                                ...
                                String product_rate =  ChemistGiftOrder.categoriesList2.get(8).getPROD_RATE();
        ...
        holder.quantity.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                ...
                holder.quantity.setBackgroundResource(R.drawable.edittextstyle);
                // ChemistGiftOrder.searchview.setFocusable(false);
                //holder.quantity.setFocusable(true);
                //return false;
					/*	if (focusvalue==0) {
