...
public class DoctorServiceTrackMonthlyAdapter extends BaseAdapter {
    ...
    DoctorServiceTrackMonthlyAdapter(Context con, ArrayList<String> product_name, ArrayList<String> item_name, ArrayList<String> type) {
    ...
    DoctorServiceTrackMonthlyAdapter(Context con, ArrayList<String> product_name, ArrayList<String> item_name, ArrayList<String> type,ArrayList<String> quant) {
        this.product_name = product_name;
        this.qnty = item_name;
        this.value = type;
        this.value4 = quant;
    ...
    DoctorServiceTrackMonthlyAdapter(Context con, ArrayList<String> product_name, ArrayList<String> item_name, ArrayList<String> type,ArrayList<String> quant,ArrayList<String> value_5) {
        this.product_name = product_name;
        this.qnty = item_name;
        this.value = type;
        this.value4 = quant;
    ...
    DoctorServiceTrackMonthlyAdapter(Context con,ArrayList<String> sl, ArrayList<String> product_name, ArrayList<String> item_name, ArrayList<String> type,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final DoctorServiceTrackMonthlyAdapter.ViewHolder holder = new DoctorServiceTrackMonthlyAdapter.ViewHolder();

        //  rowView = inflater.inflate(R.layout.viewmporeportforam, parent, false);

        rowView = inflater.inflate(R.layout.docsertrackmonadap, parent, false);
