...
public class AmNotVisitedDoctor extends Activity implements OnClickListener {
    ...
    private final String URL_PRODUCT_VIEW =BASE_URL_AM+"NotVisit.php";
    private final String URL_MPO = BASE_URL_AM+"getmpoforam.php";
    private ArrayList<com.opl.pharmavector.AmCustomer> mpolist;

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.amnotvisiteddoctor);
        ...
        Toast.makeText(AmNotVisitedDoctor.this, userName, Toast.LENGTH_LONG).show();
     ...
     //   new GetEmp().execute();
        ...
        fromdate.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new DatePickerDialog(AmNotVisitedDoctor.this, date_form, myCalendar.get(Calendar.YEAR), myCalendar.get(Calendar.MONTH),
        ...
        todate.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new DatePickerDialog(AmNotVisitedDoctor.this, date_to, myCalendar
                ...
                Thread backthred = new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            Intent i = new Intent(AmNotVisitedDoctor.this,  AmReportDashboard.class);
	...
	*/
    ...
    class Spinner {
        ...
        private void populateSpinner() {
            ...
            AmMpoDailyMonitorShowAdapter adapter = new AmMpoDailyMonitorShowAdapter(AmNotVisitedDoctor.this,sl,lables, quanty, value,value4,value5,value6,value7);
...
//        String  mar_name= mpo.getSelectedItem().toString();
      ...
      //  final String ord_no = mpoforam + "-" + date_1;
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(AmNotVisitedDoctor.this);
            pDialog.setTitle("Data Loading !");
            pDialog.setMessage("Loading Doctors..");
        ...
        protected Void doInBackground(Void... arg0) {
           ...
           // params.add(new BasicNameValuePair("mpoid", mpoforam));
            ...
            if (json != null) {
                ...
                Toast.makeText(AmNotVisitedDoctor.this, "Nothing To Disply",Toast.LENGTH_SHORT).show();
                Toast.makeText(AmNotVisitedDoctor.this, "Please make a order first !",Toast.LENGTH_LONG).show();
            }
            return null;
        }
        @Override
...
*/
    ...
    class GetEmp extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog2 = new ProgressDialog(AmNotVisitedDoctor.this);
    ...
    private void view() {
        Intent i = new Intent(AmNotVisitedDoctor.this, Report.class);
        startActivity(i);
        finish();
