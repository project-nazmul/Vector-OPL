...
@SuppressLint("ViewHolder")
    public class AmGiftListAdapter extends BaseAdapter implements Filterable {
    ...
    public AmGiftListAdapter(Activity activity,
    ...
    AmGiftListAdapter(Context con, ArrayList<String> sl,ArrayList<String> p_name, HashMap<Integer, String> p_quanty) {
                    ...
                    if (str.toString().isEmpty()) {
                        ...
                        if (checkZero > 0) {
                            ...
                            for (Iterator i = keys.iterator(); i.hasNext();) {
                                ...
                                String product_rate = GiftOrder.categoriesList.get(8).getPROD_RATE();
