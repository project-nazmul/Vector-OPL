...
public class RXShowAdapter2 extends BaseAdapter {
    TextView serial;
    CheckBox check;
    Context mContext;
    ...
    public RXShowAdapter2(Context con, ArrayList<String> product_name, ArrayList<Integer> qnty, ArrayList<String> value,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.total_prescription.setVisibility(View.GONE);
        holder.tv_totaltarget.setVisibility(View.GONE);
        return rowView;
    }
