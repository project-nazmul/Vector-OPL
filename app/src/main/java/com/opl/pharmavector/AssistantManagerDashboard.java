...
import com.opl.pharmavector.prescriptionsurvey.ASMRxSumMISActivity;
...
public class AssistantManagerDashboard extends Activity implements View.OnClickListener {
    ...
    private void showBottomSheetDialog_ProdStock() {
        ...
        Objects.requireNonNull(cardView_doctorReach).setOnClickListener(v -> {
            Intent i = new Intent(AssistantManagerDashboard.this, DoctorReachActivity.class);
            i.putExtra("UserName", globalempName);
            i.putExtra("UserCode", globalempCode);
            i.putExtra("new_version", Login.version);
            i.putExtra("message_3", message_3);
    ...
    private void isUpdateAvailable() {
        ...
        appUpdateInfoTask.addOnSuccessListener(result -> {
            if (result.updateAvailability() == UpdateAvailability.UPDATE_AVAILABLE && result.isUpdateTypeAllowed(AppUpdateType.FLEXIBLE)) {
                AlertDialog.Builder builder = new AlertDialog.Builder(AssistantManagerDashboard.this);
...
//            backthred.start();
    ...
    private void showBottomSheetDialog_DCR() {
        ...
        Objects.requireNonNull(cardview_dcfpDocList).setOnClickListener(v -> {
            Intent i = new Intent(AssistantManagerDashboard.this, DcfpDoctorListActivity.class);
            i.putExtra("UserName", globalASMCode);
            i.putExtra("UserName_2", globalZONECode);
            i.putExtra("UserRole", "ASM");
            startActivity(i);
    ...
    private void showBottomSheetDialog_RXCAPTURE() {
        ...
        Objects.requireNonNull(cardview4).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(AssistantManagerDashboard.this, ASMRxSumMISActivity.class);
                i.putExtra("ffCode", globalASMCode);
                i.putExtra("ffType", "ASM");
                startActivity(i);
            }
        });
        bottomSheetDialog2.show();
