...
public class MPODccFollowup extends Activity implements OnClickListener {
    ...
    private String URL_PRODUCT_VIEW = BASE_URL+"MPODccFollowup.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // setContentView(R.layout.dcrreport);
        ...
        setContentView(R.layout.mpodccfollowup);
        ...
        Toast.makeText(MPODccFollowup.this, userName, Toast.LENGTH_LONG).show();
        ...
        fromdate.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new DatePickerDialog(MPODccFollowup.this, date_form, myCalendar.get(Calendar.YEAR), myCalendar.get(Calendar.MONTH),
        ...
        todate.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new DatePickerDialog(MPODccFollowup.this, date_to, myCalendar
                ...
                Thread backthred = new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            Intent i = new Intent(MPODccFollowup.this,  DcrReportScreen.class);
	...
	*/
    ...
    class Spinner {
        ...
        //    MPODccStockAdapter adapter = new MPODccStockAdapter(MPODccFollowup.this,sl,lables, quanty, value,value4,value5,value6,value7);

            MPODccFollowupAdapter adapter = new MPODccFollowupAdapter(MPODccFollowup.this,sl,lables, quanty, value,value4,value5,value6,value7);
    ...
    private class GetCategories extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(MPODccFollowup.this);
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            if (json != null) {
                ...
                Toast.makeText(MPODccFollowup.this, "Nothing To Disply",Toast.LENGTH_SHORT).show();
                Toast.makeText(MPODccFollowup.this, "Please make a order first !",Toast.LENGTH_LONG).show();
            }
            return null;
        }
        @Override
        protected void onPostExecute(Void result) {
            ...
            if (pDialog.isShowing())
                pDialog.dismiss();
            MPODccFollowup.Spinner sp = new MPODccFollowup.Spinner();
            sp.populateSpinner();
            popSpinner();
...
*/
    ...
    private void view() {
        Intent i = new Intent(MPODccFollowup.this, Report.class);
        startActivity(i);
        finish();
