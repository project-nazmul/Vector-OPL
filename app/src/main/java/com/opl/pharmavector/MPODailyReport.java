...
public class MPODailyReport extends Activity implements OnClickListener {
    ...
    EditText qnty;
    TextView name_of_am,name_of_mpo;
    Boolean result;
    ...
    private final String URL_PRODUCT_VIEW =BASE_URL_RM+"MPODailyReport.php";
    private final String URL_MPO = BASE_URL_RM+"getmpoforam.php";
    private ArrayList<com.opl.pharmavector.Customer> mpolist;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mpodcrreport);
        ...
        name_of_am = (TextView) findViewById(R.id.name_of_am);
        name_of_mpo = (TextView) findViewById(R.id.name_of_mpo);
        mpo = (android.widget.Spinner) findViewById(R.id.mpo);
        mpo.setPrompt("List of Mpo");

        mpo.setFocusable(true);
        mpo.setFocusableInTouchMode(true);
        mpo.requestFocus();
        mpo.setSelected(false);  // must
        mpo.setSelection(0,true);  //must
        mpolist = new ArrayList<com.opl.pharmavector.Customer>();
        ...
        fromdate.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new DatePickerDialog(MPODailyReport.this, date_form, myCalendar.get(Calendar.YEAR), myCalendar.get(Calendar.MONTH),
        ...
        mpo.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                String  am_name_string= mpo.getSelectedItem().toString();
                String am_name_before[] = am_name_string.split("//");
                String amname=am_name_before[1].trim();
                name_of_am.setText(amname);


                String mpo_name_string=am_name_before[0].trim();
                String mpo_name_string_before[] = mpo_name_string.split("-");
                String mponame=mpo_name_string_before[1].trim();

                name_of_mpo.setText(mponame);
            }
        ...
        todate.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new DatePickerDialog(MPODailyReport.this, date_to, myCalendar
    ...
    class Spinner {
        ...
        private void populateSpinner() {
            ...
            MpoDcrReportValAdapter adapter = new MpoDcrReportValAdapter(MPODailyReport.this,sl,lables, quanty, value,value4,value5,value6,value7);
    ...
    private class GetCategories extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(MPODailyReport.this);
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            if (json != null) {
                ...
                Toast.makeText(MPODailyReport.this, "Nothing To Disply",Toast.LENGTH_SHORT).show();
                Toast.makeText(MPODailyReport.this, "Please make a order first !",Toast.LENGTH_LONG).show();
            }
            return null;
        }
        @Override
    ...
    class GetEmp extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog2 = new ProgressDialog(MPODailyReport.this);
    ...
    private void view() {
        Intent i = new Intent(MPODailyReport.this, Report.class);
        startActivity(i);
        finish();
