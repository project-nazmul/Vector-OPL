...
public class MPOGroupOrdSumDetails extends Activity implements GrpOrdSumDetailAdapter.ItemClickListener {
...
//        fromDateOrd.setText(currentFromDate);
    ...
    private void calenderClickEvents() {
        ...
        fromDateOrd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new DatePickerDialog(MPOGroupOrdSumDetails.this, dateFormOrd, fromCalendar.get(Calendar.YEAR), fromCalendar.get(Calendar.MONTH),
        ...
        toDateOrder.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new DatePickerDialog(MPOGroupOrdSumDetails.this, dateToOrder, fromCalendar
    ...
    private void getGroupOrdSummaryDetails() {
        ...
        ProgressDialog pDialog = new ProgressDialog(MPOGroupOrdSumDetails.this);
            ...
            public void onResponse(Call<GroupOrdSumDetailModel> call, Response<GroupOrdSumDetailModel> response) {
                if (response.isSuccessful()) {
                    ...
                    if (response.body() != null) {
                        ...
                        grpOrdSumDetailAdapter = new GrpOrdSumDetailAdapter(MPOGroupOrdSumDetails.this, orderSumDetailLists, MPOGroupOrdSumDetails.this);
                        LinearLayoutManager linearManager = new LinearLayoutManager(MPOGroupOrdSumDetails.this);
                        recyclerOrderSumNew.setLayoutManager(linearManager);
                        recyclerOrderSumNew.setAdapter(grpOrdSumDetailAdapter);
                        recyclerOrderSumNew.addItemDecoration(new DividerItemDecoration(MPOGroupOrdSumDetails.this, DividerItemDecoration.VERTICAL));
                    }
