...
import com.opl.pharmavector.exam.QuizQ;
...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    private static final String d_quizquestion = "QUESTION";
    private static final String d_optionA = "OPTIONA";
    private static final String d_optionB = "OPTIONB";
    private static final String d_optionC = "OPTIONC";
    private static final String d_optionD = "OPTIOND";
    private static final String d_correctanswer = "CORRECT_ANSWER";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String CREATE_TABLE_QUIZ_QUESTIONS = "CREATE TABLE " + TABLE_QUIZ_QUESTIONS + "("
                + d_quizquestion + " TEXT,"
                + d_optionA + " TEXT,"
                + d_optionB + " TEXT,"
                + d_optionC + " TEXT,"
    ...
    public void addQuiz(QuizQ quiz) {
        SQLiteDatabase db = this.getReadableDatabase();
        db.isOpen();
        ContentValues values = new ContentValues();
        values.put(d_quizquestion,  quiz.getques());
        values.put(d_optionA, quiz.getoptiona());
        values.put(d_optionB, quiz.getoptionb());
        values.put(d_optionC, quiz.getoptionc());
        values.put(d_optionD, quiz.getoptiond());
        values.put(d_correctanswer, quiz.getanswer());
    ...
    public void deleteExamtdata() {
        SQLiteDatabase db = this.getWritableDatabase();
        db.execSQL("DELETE  FROM " + TABLE_QUIZ_QUESTIONS);
    }
