...
public class AmRxCompany extends Activity implements OnClickListener {
    ...
    com.opl.pharmavector.AmRXListAdapter adapter2;
    Button submit;
    ...
    int textlength = 0;
    com.opl.pharmavector.AmRXListAdapter adapter;
    ...
    public static String URL_NEW_CATEGORY = BASE_URL_AM+"5.php";
    private final String URL_CATEGORIES = BASE_URL_AM+"get_rx_company.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.amrxcompany);
        ...
        mic.setText("\uf130");
        toast1 = Toast.makeText(AmRxCompany.this, "Please select Order Quantity  !!!.", Toast.LENGTH_LONG);
        ...
        com.opl.pharmavector.AmRXListAdapter.qnty = null;
        com.opl.pharmavector.AmRXListAdapter.qntyID.clear();
        com.opl.pharmavector.AmRXListAdapter.qntyVal.clear();
    ...
    public void swapfocus(View v){
        //	RXListAdapter.focusvalue=0;
        if (com.opl.pharmavector.AmRXListAdapter.focusvalue==0) {
            v.clearFocus();
            searchview.setFocusable(true);

            Log.e("FocusVal", ""+ com.opl.pharmavector.AmRXListAdapter.focusvalue);
    ...
    protected void onResume() {
        // TODO Auto-generated method stub
        // System.out.println("EditTxtID " + RXListAdapter.editTxtID.size());
        super.onResume();
    ...
    private void populateSpinner() {
        ...
        adapter = new com.opl.pharmavector.AmRXListAdapter(AmRxCompany.this, sl, lables, mapQuantity);
    ...
    private class GetCategories extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(AmRxCompany.this);
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            Log.v("Order_number ", "> " + "Order_number :"+ord_no);

            Log.w("dcrpagevalue ", "> " + get_mpo_code + ord_no +doc_code+end_time+start_time+Type+location_code);
                ...
                try {
                    ...
                    if (jsonObj != null) {
                        ...
                        for (int i = 0; i < categories.length(); i++) {
                            ...
                            com.opl.pharmavector.AmCategory cat = new com.opl.pharmavector.AmCategory(catObj.getString("sl"),
                                    catObj.getString("id"),
 ...
 */
            ...
            final   String no_rx = extra.getString("no_rx");
            final   String no_prod = extra.getString("no_prod");
            final   String prod_of_opsonin = extra.getString("prod_of_opsonin");
            final   String vcheckloccode = extra.getString("vcheckloccode");





            String last_quantity = com.opl.pharmavector.AmRXListAdapter.qnty;
            int last_position = com.opl.pharmavector.AmRXListAdapter.last_position;
            Log.e("value2 last_position", "  "+ last_position);
            Log.e("value2 last_quantity", "  "+ last_quantity);

            if (last_quantity != null) {
                com.opl.pharmavector.AmRXListAdapter.dataSet.put(last_position, last_quantity);
                com.opl.pharmavector.AmRXListAdapter.qntyID.add(last_position);
                com.opl.pharmavector.AmRXListAdapter.qntyVal.add(last_quantity);
                com.opl.pharmavector.AmRXListAdapter.set2.add(last_position);
            }
            if (com.opl.pharmavector.AmRXListAdapter.qntyID.size() < 1) {
                Toast.makeText(this, "No item inserted", Toast.LENGTH_SHORT).show();
            }
            else {

                Log.e("value2 Chesize()", "  "+ com.opl.pharmavector.AmRXListAdapter.qntyID.size());

                //  Toast.makeText(this, " item inserted", Toast.LENGTH_LONG).show();

                //   Toast.makeText(this, " item inserted-----else------", Toast.LENGTH_LONG).show();

                String qnty;

                /**/
                ArrayList<Integer> position = new ArrayList<Integer>();
                for (int j : com.opl.pharmavector.AmRXListAdapter.set2) {
                    position.add(j);
                }
                ...
                int k=0;
                int submit_value=0;
                for (int i = 1; i <= com.opl.pharmavector.AmRXListAdapter.p_quanty.size(); i++) {

                    int value = Integer.parseInt(com.opl.pharmavector.AmRXListAdapter.p_quanty.get(i));
                    // int value2 = Integer.parseInt(RXListAdapter.p_quanty.get(i-1));
                    Log.e("index value", "  "+ i);
                    Log.e("value", "  "+ value);
                    // Log.e("value2", "  "+ value2);
                    //    Toast.makeText(this, "RXListAdapter.p_quanty.get(i) = " + value, Toast.LENGTH_LONG).show();
                    ...
                    if (value>0) {
                        ...
                        params.add(new BasicNameValuePair("ORD_QNTY"+ String.valueOf(k), com.opl.pharmavector.AmRXListAdapter.p_quanty.get(i)));
                        ...
                        System.out.println("ORD_QNTY"+String.valueOf(k)+"="+ com.opl.pharmavector.AmRXListAdapter.p_quanty.get(i));
                        ...
                        Log.w("id pcode", " value : "+ p_ids.get(k- 1));
                        Log.w("ORD_QNTY", " Number of Products ordered value : "+ com.opl.pharmavector.AmRXListAdapter.p_quanty.get(i));
                        Log.w("PROD_RATE value", " "+ord_no_1);
                        Log.w("PROD_VAT value", "  "+ doc_code);
                        Log.w("PPM code", "PPM code :   "+ PPM_CODE.get(i- 1));
                        Log.w("Product_code", "Product Type :   "+ P_CODE.get(i- 1));
                    }
                ...
                Log.e("no_rx", "> " + no_rx);
                Log.e("no_prod", "> " + no_prod);
                Log.e("prod_of_opsonin", "> " + prod_of_opsonin);
 ...
 */
                ...
                params.add(new BasicNameValuePair("no_rx", no_rx));
                params.add(new BasicNameValuePair("no_prod",no_prod));
                params.add(new BasicNameValuePair("prod_of_opsonin",prod_of_opsonin));
                params.add(new BasicNameValuePair("vcheckloccode",vcheckloccode));
                        ...
                        public void run() {
                            ...
                            try {
                                ...
                                if (success_1 == 1) {
                                    ...
                                    com.opl.pharmavector.AmRXListAdapter.qntyID.clear();
                                    com.opl.pharmavector.AmRXListAdapter.qntyVal.clear();
                                    com.opl.pharmavector.AmRXListAdapter.set2.clear();
                                    com.opl.pharmavector.AmRXListAdapter.dataSet.clear();
                                    com.opl.pharmavector.AmRXListAdapter.p_quanty.clear();
                                    com.opl.pharmavector.AmRXListAdapter.mProductSerialList.clear();
...
//                                    SaveToDataBase();
                            ...
                            Intent sameint = new Intent(AmRxCompany.this, AmRX.class);
                            sameint.putExtra("UserName", MPO_CODE);
                            sameint.putExtra("Ord_NO", message);
                            sameint.putExtra("UserName_1", "RX Submitted");
                            sameint.putExtra("UserName_2", "RX Submitted");
        ...
        if (v.getId() == calc.getId()) {
            ...
            int total_item = com.opl.pharmavector.AmRXListAdapter.p_quanty.size();
            // System.out.println("total_item " + total_item);
            for (int i = 1; i < total_item; i++) {
                int value = Integer.parseInt(com.opl.pharmavector.AmRXListAdapter.p_quanty.get(i));
                // System.out.println("value " + value);
                if (value > 0) {
                    qnty1 = Integer.parseInt(com.opl.pharmavector.AmRXListAdapter.p_quanty.get(i));
...
/*
    ...
    private void SaveToDataBase() {
        for (int i = 1; i < RXListAdapter.p_quanty.size(); i++) {
            int value = Integer.parseInt(RXListAdapter.p_quanty.get(i));
            Intent in = getIntent();
