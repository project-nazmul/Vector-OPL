...
public class ViewbycustomerProductShowAdaptersale extends BaseAdapter {
	TextView serial;
	// TextView p_name;
	// EditText quanty;
	CheckBox check;
...
//	public static String qnty;
	...
	ViewbycustomerProductShowAdaptersale(Context con, ArrayList<String> product_name,
			ArrayList<Float> qnty, ArrayList<Float> value) {
